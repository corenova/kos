...
(function (global){
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,r=Array(t.length);e<t.length;e++)r[e]=t[e];return r}return Array.from(t)}function collectReactors(t){this.fetch("reactors").set(t.label,t)}function renderReactorByName(t){var e=this.fetch("reactors");e.has(t)?this.send("render/reactor",e.get(t)):this.warn("no such reactor:",t)}function reactorToDiagram(t){function e(t,e){return new s({source:{id:t.id,selector:".root"},target:{id:e.id,selector:".root"},attrs:{".connection":{fill:"none","stroke-linejoin":"round","stroke-width":"2",stroke:"#999999"},".marker-target":{fill:"#999999"},".connection-wrap":{display:"none"},".marker-vertices":{display:"none"},".marker-arrowheads":{display:"none"},".link-tools":{display:"none"}}})}var r=this.get("module/jointjs"),o=r.dia,n=r.shapes,a=n.pn,i=a.Place,l=a.Transition,s=a.Link,c=new o.Graph,d=new i({attrs:{".label":{fill:"#7c68fc"},".root":{stroke:"#9586fd","stroke-width":3},".tokens > circle":{fill:"#7a7e9b"}},tokens:0}),p=new l({attrs:{".label":{fill:"#fe854f"},".root":{fill:"#9586fd",stroke:"#9586fd"}}}),u=d.clone().attr(".root/stroke-width",7),f=[0,160,350,540,800,970],h=[100,260,460,650,900],b=d.clone().attr(".label/text","input"),g=d.clone().attr(".label/text","reject"),k=d.clone().attr(".label/text","core").set("kinetic","core"),m=d.clone().attr(".label/text","buffer").set("kinetic","buffer"),y=d.clone().attr(".label/text","output"),v=p.clone().attr(".label/text","accept").set("kinetic","accept"),x=p.clone().attr(".label/text","feedback").set("kinetic","feedback"),w=p.clone().attr(".label/text","consume").set("kinetic","consume"),j=p.clone().attr(".label/text","produce"),C=p.clone().attr(".label/text","send");c.addCell([b,k,g,m,y,v,w,j,x]),c.addCell([e(b,v),e(v,k),e(v,g),e(k,w),e(w,g),e(m,j),e(j,y)]);var _=50,A=!0,N=!1,S=void 0;try{for(var T,G=t.triggers[Symbol.iterator]();!(A=(T=G.next()).done);A=!0)!function(){var t=T.value,r=t.id,o=t.label,n=t.inputs,a=t.requires,i=t.outputs,l=a.concat(n),s=_,u=_,b=_;l.length>i.length?(u=_+100*(l.length-i.length)/2,b=_+100*(l.length-1)/2,_+=100*l.length):(s=_+100*(i.length-l.length)/2,b=_+100*(i.length-1)/2,_+=100*i.length);var g=p.clone().set("kinetic",r).attr(".label/text",o).position(h[2],b),k=l.map(function(t,e){return d.clone().set("kinetic","input/"+t).attr(".label/text",t).position(f[2],s+100*e)}),y=i.map(function(t,e){return d.clone().set("kinetic","output/"+t).attr(".label/text",t).position(f[3],u+100*e)});c.addCells.apply(c,_toConsumableArray(k).concat(_toConsumableArray(y),[g])),k.forEach(function(t){return c.addCell([e(w,t),e(t,g)])}),y.forEach(function(t,o){var n=C.clone().set("kinetic",r+"/send").position(h[3],u+100*o);c.addCell([n,e(g,t),e(t,n),e(n,m)])})}()}catch(t){N=!0,S=t}finally{try{!A&&G.return&&G.return()}finally{if(N)throw S}}var O=(_-50)/2;if(b.position(f[0],O),g.position(f[1],O-50),k.position(f[1],O+50),m.position(f[4],O),y.position(f[5],O),v.position(h[0],O),w.position(h[1],O),j.position(h[4],O),t.reactors.length){var P=_+100*(t.reactors.length-1)/2,R=p.clone().attr(".label/text","absorb").position(h[1],P);c.addCell([R,e(k,R)]);var J=!0,$=!1,q=void 0;try{for(var z,B=t.reactors[Symbol.iterator]();!(J=(z=B.next()).done);J=!0){var D=z.value,E=u.clone().set("ref",D.id).attr(".label/text",D.label).position(f[2],_),L=C.clone().position(h[3],_);c.addCell([E,L,e(R,E),e(E,L),e(L,m)]),_+=100}}catch(t){$=!0,q=t}finally{try{!J&&B.return&&B.return()}finally{if($)throw q}}}x.position(h[2],_-25),c.addCell([e(x,k).set("router",{name:"orthogonal"}),e(m,x).set("router",{name:"orthogonal"}).set("vertices",[{x:f[4]+25,y:_}])]),this.send("joint/graph",c)}function renderGraphToPaper(t,e){var r=this.get("module/jointjs"),o=(this.get("browser/document"),new r.dia.Graph);e=Object.assign({gridSize:10,perpendicularLinks:!0},e,{model:o});var n=new r.dia.Paper(e);t instanceof r.dia.Graph?o.fromJSON(t.toJSON()):o.fromJSON(t),n.fitToContent({padding:e.padding,allowNewOrigin:"any"}),this.send("joint/paper",n)}var _global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos;module.exports=kos.reactor("render").desc("Provides Kinetic Reactor visualization").init("reactors",new Map).in("render/reactor").and.has("module/jointjs").out("joint/graph").bind(reactorToDiagram).in("render/reactor/name").out("render/reactor").bind(renderReactorByName).in("reactor").bind(collectReactors).in("joint/graph","joint/paper/config").and.has("module/jointjs").out("joint/paper").bind(renderGraphToPaper);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
