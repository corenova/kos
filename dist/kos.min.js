...
(function (global){
"use strict";function classifyRequest(e){if(!e.method)return this.throw("invalid METHOD");switch(e.method.toUpperCase()){case"GET":this.send("http/request/get",e);break;case"POST":this.send("http/request/post",e);break;case"PUT":this.send("http/request/put",e);break;case"PATCH":this.send("http/request/patch",e);break;case"DELETE":this.send("http/request/delete",e)}}function handleRequest(e){var t=this,s=this.fetch("module/superagent"),u=this.trigger.replace(/.*\/(\w+)$/,"$1").toLowerCase(),r=e.url,o=e.data;switch(u){case"get":case"delete":s[u](r).end(function(e,s){e?t.throw(e):t.send("http/response",s)});break;case"post":case"put":case"patch":s[u](r).send(o).end(function(e,s){e?t.throw(e):t.send("http/response",s)})}}var _global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos;module.exports=kos.create("http-client").summary("Provides HTTP client transforms utilizing 'superagent' module").require("module/http").require("module/superagent").in("http/request").out("http/request/get").out("http/request/post").out("http/request/put").out("http/request/patch").out("http/request/delete").bind(classifyRequest).in("http/request/get").out("http/response").bind(handleRequest).in("http/request/post").out("http/response").bind(handleRequest).in("http/request/put").out("http/response").bind(handleRequest).in("http/request/patch").out("http/response").bind(handleRequest).in("http/request/delete").out("http/response").bind(handleRequest);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined}],2:[function(require,module,exports){
(function (global){
"use strict";function createServer(e){var t=this,r=this.fetch("module/http"),o=normalizeOptions.call(this,e),s=o.protocol,n=o.hostname,i=o.port,a=r.createServer(function(e,r){t.send("http/server/request",{req:e,res:r})});a.on("connection",function(e){var r=s+"//"+e.remoteAddress+":"+e.remotePort;t.info("accept",r),t.send("http/socket",e),t.send("http/link",{addr:r,socket:e}),e.emit("active")}),a.on("listening",function(){t.info("listening",n,i),t.send("http/server",a)}),a.on("error",this.error.bind(this)),this.debug("attempt",n,i),a.listen(i,n)}function classifyServerTransaction(e){var t=e.req,r=(e.res,t.method.toLowerCase());this.send("http/server/request/"+r,e)}function normalizeOptions(e){if("string"==typeof e){var t=this.fetch("module/url");e.includes("://")||(e="http://"+e),e=t.parse(e,!0)}return{protocol:e.protocol||"http:",hostname:e.hostname||"0.0.0.0",port:parseInt(e.port,10)||80}}function handleRoute(e,t){}var _global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos;module.exports=kos.create("http-server").summary("Provides HTTP server transactions").require("module/http").require("module/url").in("http/listen").out("http/server","http/socket","http/link","http/server/request").bind(createServer).in("http/server/request").out("http/server/request/*").bind(classifyServerTransaction).in("http/server","http/route").out("http/server/request").bind(handleRoute);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined}],3:[function(require,module,exports){
(function (global){
"use strict";function proxy(t,e){t.host=e.host,this.send("http/request",t)}var _global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos;module.exports=kos.create("http").summary("Provides HTTP client and/or server transforms").include(require("./http-client")).include(require("./http-server")).in("http/request/get/url").out("http/request/get").bind(function(t){this.send("http/request/get",{url:t})}).in("http/server/request","http/proxy").out("http/request").bind(proxy);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined,"./http-client":1,"./http-server":2}],4:[function(require,module,exports){
(function (global){
"use strict";function connect(e){switch(e.protocol){case"ws:":case"wss:":this.send("ws/connect",e);break;case"tcp:":case"udp:":case void 0:this.send("net/connect",e);break;default:this.warn("unsupported protocol",e.protocol)}}function listen(e){switch(e.protocol){case"ws:":case"wss:":this.send("ws/listen",e);break;case"tcp:":case"udp:":case void 0:this.send("net/listen",e);break;default:this.warn("unsupported protocol",e.protocol)}}function connectByUrl(e){var n=this.fetch("module/url"),t=n.parse(e,!0);t.protocol||(t=n.parse("tcp:"+e,!0)),this.send("link/connect",Object.assign(t,t.query))}function listenByUrl(e){var n=this.fetch("module/url"),t=n.parse(e,!0);t.protocol||(t=n.parse("tcp:"+e,!0)),this.send("link/listen",Object.assign(t,t.query))}function createNetStream(e){var n=this,t=e.addr,s=e.socket,o=this.fetch("streams"),i=o.has(t)?o.get(t):new kos.Essence;s.on("active",function(){var e=i.io();s.pipe(e,{end:!1}).pipe(s),s.on("close",function(){e.unpipe(s),s.destroy()})}),o.has(t)||(i.on("ready",function(){return n.debug("ready now!")}),o.set(t,i),this.send("link/stream",i))}function createWebSocketStream(e){var n=this,t=e.addr,s=e.socket,o=this.fetch("streams"),i=o.has(t)?o.get(t):new kos.Essence;s.on("active",function(){var e=i.io();s.pipe(e,{end:!1}).pipe(s),s.on("close",e.unpipe.bind(e,s))}),o.has(t)||(i.on("ready",function(){return n.debug("ready now!")}),o.set(t,i),this.send("link/stream",i))}var _global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos;module.exports=kos.create("link").summary("Provides dynamic client/server communication flows for various protocols").require("module/url").default("streams",new Map).import(require("./net")).import(require("./ws")).in("link/connect").out("net/connect","ws/connect").bind(connect).in("link/listen").out("net/listen","ws/listen").bind(listen).in("link/connect/url").out("link/connect").bind(connectByUrl).in("link/listen/url").out("link/listen").bind(listenByUrl).in("net/link").out("link/stream").bind(createNetStream).in("ws/link").out("link/stream").bind(createWebSocketStream);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined,"./net":5,"./ws":7}],5:[function(require,module,exports){
(function (global){
"use strict";function ready(t,e){}function connect(t){var e=this,n=this.fetch("module/net","protocols"),o=_slicedToArray(n,2),r=o[0],i=o[1],s=normalizeOptions.call(this,t),c=s.protocol,l=s.hostname,a=s.port,u=s.retry,d=s.max;if(!i.includes(c))return this.error("unsupported protocol",c);var m=c+"//"+l+":"+a,p=new r.Socket;this.send("net/link",{addr:m,socket:p}),p.setNoDelay(),p.on("connect",function(){e.info("connected to",m),e.send("net/socket",p),p.emit("active"),u&&(u=100)}),p.on("close",function(){p.closing||u&&setTimeout(function(){e.debug("attempt reconnect",m),e.feed("net/connect",Object.assign({},t,{retry:Math.round(Math.min(d,1.5*u))}))},u)}),p.on("error",this.error.bind(this)),this.debug("attempt",m),p.connect(a,l)}function listen(t){var e=this,n=this.fetch("module/net"),o=normalizeOptions(t),r=o.protocol,i=o.hostname,s=o.port,c=(o.retry,o.max,n.createServer(function(t){var n=r+"//"+t.remoteAddress+":"+t.remotePort;e.info("accept",n),e.send("net/socket",t),e.send("net/link",{addr:n,socket:t}),t.emit("active")}));c.on("listening",function(){e.info("listening",i,s),e.send("net/server",c)}),c.on("error",this.error.bind(this)),this.debug("attempt",i,s),c.listen(s,i)}function connectByUrl(t){var e=this.fetch("module/url");t.includes("://")||(t="tcp://"+t);var n=e.parse(t,!0);this.send("net/connect",Object.assign(n,n.query))}function listenByUrl(t){var e=this.fetch("module/url");t.includes("://")||(t="tcp://"+t);var n=e.parse(t,!0);this.send("net/listen",Object.assign(n,n.query))}function normalizeOptions(t){return{protocol:t.protocol||"tcp:",hostname:t.hostname||"0.0.0.0",port:parseInt(t.port,10)||12345,retry:parseInt(t.retry,10)||100,max:parseInt(t.max,10)||5e3}}var _slicedToArray=function(){function t(t,e){var n=[],o=!0,r=!1,i=void 0;try{for(var s,c=t[Symbol.iterator]();!(o=(s=c.next()).done)&&(n.push(s.value),!e||n.length!==e);o=!0);}catch(t){r=!0,i=t}finally{try{!o&&c.return&&c.return()}finally{if(r)throw i}}return n}return function(e,n){if(Array.isArray(e))return e;if(Symbol.iterator in Object(e))return t(e,n);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos;module.exports=kos.create("net").summary("Provides network client/server communication flows").require("module/net","module/url").default("protocols",["tcp:","udp:"]).in("module/net","module/url").bind(ready).in("net/connect").out("net/socket","net/link").bind(connect).in("net/listen").out("net/server","net/socket","net/link").bind(listen).in("net/connect/url").out("net/connect").bind(connectByUrl).in("net/listen/url").out("net/listen").bind(listenByUrl);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined}],6:[function(require,module,exports){
(function (global){
"use strict";var _global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos;module.exports=kos.create("sync").summary("Provide dataflow stream pull/push to a remote flow").import(require("./link")).in("sync/connect").out("link/connect/url").bind(function(n){this.send("link/connect/url",n)}).in("sync/listen").out("link/listen/url").bind(function(n){this.send("link/listen/url",n)}).in("link/stream").bind(function(n){n.pipe(this.stream).pipe(n)});
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined,"./link":4}],7:[function(require,module,exports){
(function (global){
"use strict";function connect(e){var t=this,s=this.fetch("module/simple-websocket"),o=this.fetch("protocols"),n=normalizeOptions(e),r=n.protocol,i=n.hostname,c=n.port,l=n.path,a=n.retry,u=n.max;if(!o.includes(r))return this.error("unsupported protocol",r);var d=r+"//"+i+":"+c+"/"+l,w=new s(d);this.send("ws/link",{addr:d,socket:w}),w.on("connect",function(){t.info("connected to",d),t.send("ws/socket",w),w.emit("active"),a&&(a=100)}),w.on("close",function(){a&&setTimeout(function(){t.debug("attempt reconnect",d),t.feed("ws/connect",Object.assign({},e,{retry:Math.round(Math.min(u,1.5*a))}))},a)}),w.on("error",this.error.bind(this))}function listen(e){var t=this,s=this.fetch("module/simple-websocket/server"),o=this.fetch("protocols"),n=normalizeOptions(e),r=n.protocol,i=n.hostname,c=n.port,l=n.path,a=n.server;if(!o.includes(r))return this.error("unsupported protocol",r);a?(a=new s({server:a}),this.info("listening on existing server instance"),this.send("ws/server",a)):(a=new s({host:i,port:c,path:l}),a.on("listening",function(){t.info("listening",i,c,l),t.send("ws/server",a)})),a.on("connection",function(e){var s=e._ws._socket,o=r+"//"+s.remoteAddress+":"+s.remotePort;t.info("accept",o),t.send("ws/socket",e),t.send("ws/link",{addr:o,socket:e}),e.emit("active")}),a.on("error",this.error.bind(this))}function connectByUrl(e){var t=this.fetch("module/url");e.includes("://")||(e="ws://"+e);var s=t.parse(e,!0);this.send("ws/connect",Object.assign(s,s.query))}function listenByUrl(e){var t=this.fetch("module/url");e.includes("://")||(e="ws://"+e);var s=t.parse(e,!0);this.send("ws/listen",Object.assign(s,s.query))}function normalizeOptions(e){return{protocol:e.protocol||"ws:",hostname:e.hostname||"0.0.0.0",port:parseInt(e.port,10)||80,path:e.path||"",server:e.server,retry:parseInt(e.retry,10)||100,max:parseInt(e.max,10)||5e3}}var _global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos,clientFlow=kos.create("client").require("module/simple-websocket").in("ws/connect").out("ws/socket","ws/link").bind(connect),serverFlow=kos.create("server").require("module/simple-websocket/server").in("ws/listen").out("ws/server","ws/socket","ws/link").bind(listen);module.exports=kos.create("ws").summary("Provides WebSocket transactions utilizing 'ws' module").require("module/url").default("protocols",["ws:","wss:"]).include(clientFlow,serverFlow).in("ws/connect/url").out("ws/connect").bind(connectByUrl).in("ws/listen/url").out("ws/listen").bind(listenByUrl);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined}],8:[function(require,module,exports){
"use strict";var delegate=require("delegates"),proto=module.exports={};delegate(proto,"reactor").getter("state").getter("inputs").getter("outputs").getter("stream").method("fetch").method("post").method("send").method("feed").method("debug").method("info").method("warn").method("error").method("throw"),delegate(proto,"state").method("clear").method("delete").method("entries").method("forEach").method("get").method("has").method("set").method("keys").method("set").method("values");
},{"delegates":23}],9:[function(require,module,exports){
(function (__dirname){
"use strict";function loadFlow(e){var o={},t=[path.resolve(e),path.resolve(path.join("flows",e)),path.resolve(__dirname,path.join("flows",e)),e],r=!0,i=!1,n=void 0;try{for(var a,s=t[Symbol.iterator]();!(r=(a=s.next()).done);r=!0){var u=a.value;try{o=require(u);break}catch(e){if("MODULE_NOT_FOUND"!==e.code)throw e}}}catch(e){i=!0,n=e}finally{try{!r&&s.return&&s.return()}finally{if(i)throw n}}if("KineticObjectStream"!==o.type)throw new Error("unable to load KOS for "+e+" from "+t);this.send("flow",o)}function includeFlow(e){this.stream.include(e)}function setupLogger(e){var o=e.verbose,t=void 0===o?0:o,r=e.silent;if(void 0===r||!r){var i=["kos:error","kos:warn"];t&&i.push("kos:info"),t>1&&i.push("kos:debug"),t>2&&i.push("kos:trace"),debug.enable(i.join(","));var n=debug("kos:error"),a=debug("kos:warn"),s=debug("kos:info"),u=debug("kos:debug"),l=debug("kos:trace");this.get("initialized")||(this.stream.on("data",function(e){var o=e.key,r=e.value;switch(o){case"error":n(t>1?r:r.message);break;case"warn":a(r.join(" "));break;case"info":s(r.join(" "));break;case"debug":u(r.join(" "));break;default:switch(void 0===r?"undefined":_typeof(r)){case"function":case"object":l("%s\n%O\n",o,r);break;default:l("%s %o",o,r)}}}),this.set("initialized",!0))}}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},debug=require("debug"),path=require("path"),KineticObjectStream=require("./stream");module.exports=new KineticObjectStream("core").summary("Provides KOS flow loading & logging facility").in("load").out("flow").bind(loadFlow).in("flow").out("load").bind(includeFlow).in("log").bind(setupLogger);
}).call(this,"/lib")
},{"./stream":13,"debug":21,"path":30}],10:[function(require,module,exports){
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}();try{var debug=require("debug")("kos:essence")}catch(e){var debug=function(){}}var uuid=require("uuid"),_require=require("stream"),Transform=_require.Transform,Duplex=_require.Duplex,KineticObject=require("./object"),KineticEssence=function(e){function t(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};_classCallCheck(this,t),e instanceof t&&(e=e.inspect()),e.objectMode=!0;var r=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e));return r.id=uuid(),e.state instanceof Map?r.state=e.state:r.state=new Map(e.state),r.buffer="",r.on("end",r.warn.bind(r,"kinetic essence died unexpectedly")),e.maxListeners&&r.setMaxListeners(e.maxListeners),r}return _inherits(t,e),_createClass(t,[{key:Symbol.toStringTag,get:function(){return"KineticEssence"}}],[{key:"Object",get:function(){return KineticObject},set:function(e){KineticObject=e}},{key:"type",get:function(){return Symbol.for("kinetic.essence")}}]),_createClass(t,[{key:"_transform",value:function(e,t,r){if(!(e instanceof KineticObject))return r(new Error("chunk is not a KineticObject"));this.seen(e)?r():r(null,this.mark(e))}},{key:"default",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"",t=arguments[1];if(e.constructor===Object)for(var r in e)this.state.set(r,e[r]);else this.state.set(e,t);return this}},{key:"seen",value:function(e){return e.tags.has(this.id)}},{key:"mark",value:function(e,t){return e.tag(this.id,t)}},{key:"join",value:function(e){if(!(e instanceof t))throw new Error("[join] can only join to other KineticEssences, sorry",e);return this.state.set("parent",e),this}},{key:"io",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},r=e.passthrough,n=void 0!==r&&r,i=(e.verbose,this),o="",a=[],s=new t({transform:function(e,t,r){if(e instanceof KineticObject)return r(null,e);o+=e,a=o.split(/\r?\n/),a.length&&(o=a.pop());var n=!0,s=!1,c=void 0;try{for(var u,l=a.filter(Boolean)[Symbol.iterator]();!(n=(u=l.next()).done);n=!0){var f=u.value;try{var h=KineticObject.fromKSON(f.trim());i.write(this.mark(h))}catch(e){i.error(e)}}}catch(e){s=!0,c=e}finally{try{!n&&l.return&&l.return()}finally{if(s)throw c}}r()}});return this.on("data",function(e){!n&&s.seen(e)||/^module\//.test(e.key)||["flow","error","warn","info","debug"].includes(e.key)||(debug("io:push",e.key),s.push(e.toKSON()+"\n"))}),s.join(this)}},{key:"filter",value:function(){for(var e=arguments.length,r=Array(e),n=0;n<e;n++)r[n]=arguments[n];var i=new Set(r);return this.pipe(new t({transform:function(e,t,r){e&&e.match(i)?r(null,e):r()}}))}},{key:"fetch",value:function(){for(var e=this,t=arguments.length,r=Array(t),n=0;n<t;n++)r[n]=arguments[n];if(r.every(function(t){return e.state.has(t)})){var i=r.map(function(t){return e.state.get(t)});return i.length>1?i:i[0]}if(this.state.has("parent")){var o=this.state.get("parent");return o.fetch.apply(o,r)}}},{key:"post",value:function(e,t){if(this.state.has("parent")){var r=this.state.get("parent"),n=r.state;if(n&&n.has(e)){var i=n.get(e);if(i instanceof Set)return i.add(t)}n.set(e,t)}}},{key:"feed",value:function(e){for(var t=arguments.length,r=Array(t>1?t-1:0),n=1;n<t;n++)r[n-1]=arguments[n];var i=!0,o=!1,a=void 0;try{for(var s,c=r[Symbol.iterator]();!(i=(s=c.next()).done);i=!0){var u=s.value;this.write(new KineticObject(e,u))}}catch(e){o=!0,a=e}finally{try{!i&&c.return&&c.return()}finally{if(o)throw a}}return this}},{key:"log",value:function(e){for(var t=arguments.length,r=Array(t>1?t-1:0),n=1;n<t;n++)r[n-1]=arguments[n];this.push(new KineticObject(e,[this.identity].concat(r),this.id))}},{key:"debug",value:function(){this.log.apply(this,["debug"].concat(Array.prototype.slice.call(arguments)))}},{key:"info",value:function(){this.log.apply(this,["info"].concat(Array.prototype.slice.call(arguments)))}},{key:"warn",value:function(){this.log.apply(this,["warn"].concat(Array.prototype.slice.call(arguments)))}},{key:"error",value:function(e){for(var t=arguments.length,r=Array(t>1?t-1:0),n=1;n<t;n++)r[n-1]=arguments[n];return e instanceof Error||(e=new Error([e].concat(r).join(" "))),e.flow=this,this.push(new KineticObject("error",e,this.id)),e}},{key:"inspect",value:function(){return{id:this.id,type:this.type,state:Array.from(this.state)}}},{key:"toJSON",value:function(){var e=this.inspect();return delete e.state,e}},{key:"type",get:function(){return this.constructor.name}},{key:"identity",get:function(){return this.id}},{key:"throw",get:function(){return this.error}}]),t}(Transform);module.exports=KineticEssence;
},{"./object":11,"debug":21,"stream":44,"uuid":47}],11:[function(require,module,exports){
"use strict";function _classCallCheck(r,t){if(!(r instanceof t))throw new TypeError("Cannot call a class as a function")}var _slicedToArray=function(){function r(r,t){var e=[],n=!0,a=!1,i=void 0;try{for(var u,l=r[Symbol.iterator]();!(n=(u=l.next()).done)&&(e.push(u.value),!t||e.length!==t);n=!0);}catch(r){a=!0,i=r}finally{try{!n&&l.return&&l.return()}finally{if(a)throw i}}return e}return function(t,e){if(Array.isArray(t))return t;if(Symbol.iterator in Object(t))return r(t,e);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_createClass=function(){function r(r,t){for(var e=0;e<t.length;e++){var n=t[e];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(r,n.key,n)}}return function(t,e,n){return e&&r(t.prototype,e),n&&r(t,n),t}}(),CircularJSON=require("circular-json"),KineticObject=function(){function r(t,e){var n=this;_classCallCheck(this,r),this.key=t,this.value=e,this.tags=new Map;for(var a=arguments.length,i=Array(a>2?a-2:0),u=2;u<a;u++)i[u-2]=arguments[u];i.forEach(function(r){return n.tag(r)})}return _createClass(r,null,[{key:"fromKSON",value:function(t){var e=t.split(/\s+(.+)/),n=_slicedToArray(e,2),a=n[0],i=n[1];if(!a||!i)throw new Error("invalid KSON, must define key and argument");return i=CircularJSON.parse(i),new r(a,i)}}]),_createClass(r,[{key:"tag",value:function(r,t){return this.tags.set(r,t),this}},{key:"match",value:function(){var r=arguments.length>0&&void 0!==arguments[0]?arguments[0]:new Set;if(r.has(this.key))return!0;var t=!0,e=!1,n=void 0;try{for(var a,i=r[Symbol.iterator]();!(t=(a=i.next()).done);t=!0){var u=a.value;if(u.indexOf("*")!==-1){var l="^"+u.replace("*",".*")+"$";if(null!=this.key.match(l))return!0}}}catch(r){e=!0,n=r}finally{try{!t&&i.return&&i.return()}finally{if(e)throw n}}return!1}},{key:"toKSON",value:function(){var r=this.key,t=this.value;return r+" "+CircularJSON.stringify(t)}},{key:"toJSON",value:function(){var r=this.key,t=this.value;return"function"==typeof t&&(t=null),'{"'+r+'":'+CircularJSON.stringify(t)+"}"}},{key:"accepted",get:function(){var r=!0,t=!1,e=void 0;try{for(var n,a=this.tags.values()[Symbol.iterator]();!(r=(n=a.next()).done);r=!0){if(n.value)return!0}}catch(r){t=!0,e=r}finally{try{!r&&a.return&&a.return()}finally{if(t)throw e}}return!1}}]),r}();module.exports=KineticObject;
},{"circular-json":19}],12:[function(require,module,exports){
"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}var _get=function t(e,r,n){null===e&&(e=Function.prototype);var i=Object.getOwnPropertyDescriptor(e,r);if(void 0===i){var o=Object.getPrototypeOf(e);return null===o?void 0:t(o,r,n)}if("value"in i)return i.value;var a=i.get;if(void 0!==a)return a.call(n)},_createClass=function(){function t(t,e){for(var r=0;r<e.length;r++){var n=e[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(e,r,n){return r&&t(e.prototype,r),n&&t(e,n),e}}();try{var debug=require("debug")("kos:reactor")}catch(t){var debug=function(){}}var KineticEssence=require("./essence"),KineticContext=require("./context"),KineticReactor=function(t){function e(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};_classCallCheck(this,e);var r=_possibleConstructorReturn(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t)),n=t.inputs,i=void 0===n?[]:n,o=t.outputs,a=void 0===o?[]:o,u=t.handler,s=void 0===u?e.none:u;return i&&!Array.isArray(i)&&(i=[i]),a&&!Array.isArray(a)&&(a=[a]),r._inputs=new Set(i),r._outputs=new Set(a),r._handler=s,r}return _inherits(e,t),_createClass(e,[{key:Symbol.toStringTag,get:function(){return"KineticReactor"}}],[{key:"none",value:function(){}}]),_createClass(e,[{key:"_transform",value:function(t,r,n){var i=this;if(this.handler===e.none)return n();_get(e.prototype.__proto__||Object.getPrototypeOf(e.prototype),"_transform",this).call(this,t,r,function(t,e){if(t)return n(t);if(i.ready(e)){var r=i.context;r.trigger=e.key,r.arguments=i.inputs.map(function(t){return i.state.get(t)}),debug(i.identity,"ƒ("+i.inputs+")");try{i.handler.apply(r,r.arguments)}catch(t){i.error(t)}}n()})}},{key:"ready",value:function(t){var e=this;return!(!t||!t.match(this._inputs))&&(this.state.set(t.key,t.value),this.inputs.every(function(t){return e.state.has(t)}))}},{key:"in",value:function(){for(var t=arguments.length,e=Array(t),r=0;r<t;r++)e[r]=arguments[r];var n=!0,i=!1,o=void 0;try{for(var a,u=e.filter(Boolean)[Symbol.iterator]();!(n=(a=u.next()).done);n=!0){var s=a.value;this._inputs.add(s)}}catch(t){i=!0,o=t}finally{try{!n&&u.return&&u.return()}finally{if(i)throw o}}return this}},{key:"out",value:function(){for(var t=arguments.length,e=Array(t),r=0;r<t;r++)e[r]=arguments[r];var n=!0,i=!1,o=void 0;try{for(var a,u=e.filter(Boolean)[Symbol.iterator]();!(n=(a=u.next()).done);n=!0){var s=a.value;this._outputs.add(s)}}catch(t){i=!0,o=t}finally{try{!n&&u.return&&u.return()}finally{if(i)throw o}}return this}},{key:"bind",value:function(t){var e=this.state.get("parent");if("function"!=typeof t)throw new Error("[bind] expected function but got something else");return this._handler=t,e?e.include(this):this}},{key:"send",value:function(t,e){var r=new KineticEssence.Object(t,e,this.id);if(!r.match(this._outputs))throw new Error("[KineticReactor:send] "+t+" not in ["+this.outputs+"]");return this.push(r)}},{key:"inspect",value:function(){return Object.assign(_get(e.prototype.__proto__||Object.getPrototypeOf(e.prototype),"inspect",this).call(this),{label:this.label,inputs:this.inputs,outputs:this.outputs,handler:this.handler})}},{key:"stream",get:function(){return this.state.get("parent")}},{key:"inputs",get:function(){return Array.from(this._inputs)}},{key:"outputs",get:function(){return Array.from(this._outputs)}},{key:"handler",get:function(){return this._handler}},{key:"context",get:function(){var t=Object.create(KineticContext);return t.reactor=this,t}},{key:"label",get:function(){return this.handler.name}},{key:"identity",get:function(){var t=this.state.get("parent");return t?t.identity+":"+this.handler.name:this.handler.name}}]),e}(KineticEssence);module.exports=KineticReactor;
},{"./context":8,"./essence":10,"debug":21}],13:[function(require,module,exports){
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,r=Array(t.length);e<t.length;e++)r[e]=t[e];return r}return Array.from(t)}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}var _slicedToArray=function(){function t(t,e){var r=[],n=!0,i=!1,a=void 0;try{for(var o,s=t[Symbol.iterator]();!(n=(o=s.next()).done)&&(r.push(o.value),!e||r.length!==e);n=!0);}catch(t){i=!0,a=t}finally{try{!n&&s.return&&s.return()}finally{if(i)throw a}}return r}return function(e,r){if(Array.isArray(e))return e;if(Symbol.iterator in Object(e))return t(e,r);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_get=function t(e,r,n){null===e&&(e=Function.prototype);var i=Object.getOwnPropertyDescriptor(e,r);if(void 0===i){var a=Object.getPrototypeOf(e);return null===a?void 0:t(a,r,n)}if("value"in i)return i.value;var o=i.get;if(void 0!==o)return o.call(n)},_createClass=function(){function t(t,e){for(var r=0;r<e.length;r++){var n=e[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(e,r,n){return r&&t(e.prototype,r),n&&t(e,n),e}}();try{var debug=require("debug")("kos:stream")}catch(t){var debug=function(){}}var KineticEssence=require("./essence"),KineticReactor=require("./reactor"),KINETIC_CORE_MAX=30,KineticObjectStream=function(t){function e(t){if(_classCallCheck(this,e),t instanceof e&&(t=t.inspect(),debug(t.label,"cloning")),"string"==typeof t&&(t={label:t}),!t.label)throw new Error("must supply 'label' to create a new KOS");var r=_possibleConstructorReturn(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t)),n=t,i=n.label,a=n.summary,o=n.requires,s=void 0===o?[]:o,u=n.imports,c=void 0===u?[]:u,l=n.subflows,f=void 0===l?[]:l,y=n.reactors,h=void 0===y?[]:y;return s=[].concat(s).filter(String),c=[].concat(c).filter(String),r._label=i,r._summary=a,r._requires=new Set(s),r._subflows=new Set,r._reactors=new Set,r._imports=new Map,r.default({consumes:new Set,produces:new Set,absorbs:new Set}),r.core=new KineticEssence({maxListeners:KINETIC_CORE_MAX,transform:function(t,e,n){if(!t)return n();if(r.seen(t)){if(!r.consume(t))return n()}else if(!r.produce(t))return n();n(null,t)}}),r.pipe(r.core).pipe(r),f=[].concat(f).filter(Boolean).map(function(t){return t instanceof e?t:new e(t)}),h=[].concat(h).filter(Boolean).map(function(t){return t instanceof KineticReactor?t:new KineticReactor(t)}),r.include.apply(r,_toConsumableArray(f).concat(_toConsumableArray(h))),r.import.apply(r,_toConsumableArray(c)),r.state.set("ready",!1),debug(r.identity,"new",r.id),r}return _inherits(e,t),_createClass(e,[{key:Symbol.toStringTag,get:function(){return"KineticObjectStream:"+this.label}}]),_createClass(e,[{key:"create",value:function(t){return new e(t)}},{key:"_transform",value:function(t,r,n){var i=this;_get(e.prototype.__proto__||Object.getPrototypeOf(e.prototype),"_transform",this).call(this,t,r,function(t,e){return t?n(t):e?(i.accept(e)?i.core.resume():i.core.pause(),void n(null,e)):n()})}},{key:"accept",value:function(t){var e=this;return!!this.ready||(this._requires.has(t.key)&&this.state.set(t.key,t.value),this.requires.every(function(t){return e.state.has(t)})&&(this.state.set("ready",!0),this.info(this.id,"ready"),this.emit("ready",this)),this.ready)}},{key:"consume",value:function(t){var e=this.state.get("consumes");if("flow"===t.key&&this._imports.size){var r=t.value;this._imports.has(r.label)&&(debug(this.identity,"<<<",r.label),this.import(r))}return e.size&&!t.match(e)?(this.emit("reject",t),!1):(this.ready?(debug(this.identity,"<==",t.key),this.emit("consume",t)):(debug(this.identity,"<++",t.key),this.emit("queue",t),this.debug("queue",t.key)),this.mark(t,!0),!0)}},{key:"produce",value:function(t){var e=this.state.get("produces"),r=this.state.get("absorbs");return!t.match(e)||t.match(r)?(debug(this.identity,"<->",t.key),this.emit("absorb",t),this.mark(t)):(debug(this.identity,"==>",t.key),this.emit("produce",t)),this.state.has("parent")||"error"===t.key||this.emit(t.key,t.value),!0}},{key:"summary",value:function(t){return t?(this._summary=t,this):this._summary}},{key:"require",value:function(t){function e(){return t.apply(this,arguments)}return e.toString=function(){return t.toString()},e}(function(){for(var t=arguments.length,e=Array(t),r=0;r<t;r++)e[r]=arguments[r];var n=!0,i=!1,a=void 0;try{for(var o,s=e.filter(String)[Symbol.iterator]();!(n=(o=s.next()).done);n=!0){var u=o.value;if(/^module\//.test(u)){var c=u.match(/^module\/(.+)$/,"$1");try{this.state.set(u,require(c[1]))}catch(t){debug("unable to auto-load require",u)}}this._requires.add(u)}}catch(t){i=!0,a=t}finally{try{!n&&s.return&&s.return()}finally{if(i)throw a}}return this})},{key:"import",value:function(){for(var t=(this.state.get("transforms"),arguments.length),r=Array(t),n=0;n<t;n++)r[n]=arguments[n];var i=!0,a=!1,o=void 0;try{for(var s,u=r.filter(Boolean)[Symbol.iterator]();!(i=(s=u.next()).done);i=!0){var c=s.value;if(c instanceof e){if(this._imports.get(c.label))continue;c=new e(c).join(this),this._imports.set(c.label,c),this.core.pipe(c).pipe(this.core)}else this._imports.set(c)}}catch(t){a=!0,o=t}finally{try{!i&&u.return&&u.return()}finally{if(a)throw o}}return this.updateState(),this}},{key:"include",value:function(){for(var t=arguments.length,e=Array(t),r=0;r<t;r++)e[r]=arguments[r];var n=!0,i=!1,a=void 0;try{for(var o,s=e.filter(Boolean)[Symbol.iterator]();!(n=(o=s.next()).done);n=!0){var u=o.value;switch(u.type){case"KineticObjectStream":this._subflows.add(u);break;case"KineticReactor":this.state.has(u.handler)?u.state=this.state.get(u.handler):this.state.set(u.handler,u.state),this._reactors.add(u);break;default:throw new Error("[include] can only absorb an instance of KineticEssence")}this.core.pipe(u.join(this)).pipe(this.core)}}catch(t){i=!0,a=t}finally{try{!n&&s.return&&s.return()}finally{if(i)throw a}}return this.updateState(),this}},{key:"exclude",value:function(){for(var t=arguments.length,e=Array(t),r=0;r<t;r++)e[r]=arguments[r];var n=!0,i=!1,a=void 0;try{for(var o,s=e.filter(Boolean)[Symbol.iterator]();!(n=(o=s.next()).done);n=!0){var u=o.value;switch(u.type){case"KineticObjectStream":this._subflows.delete(u);break;case"KineticReactor":this._reactors.delete(u);break;default:throw new Error("[exclude] can only remove an instance of KineticEssence")}this.core.unpipe(u)}}catch(t){i=!0,a=t}finally{try{!n&&s.return&&s.return()}finally{if(i)throw a}}return this.updateState(),this}},{key:"chain",value:function(){for(var t=arguments.length,e=Array(t),r=0;r<t;r++)e[r]=arguments[r];var n=e.reduce(function(t,e){return t.pipe(e)},this);return n&&n.pipe(this),this}},{key:"updateState",value:function(){var t,e,r=(t=[]).concat.apply(t,[this.requires].concat(_toConsumableArray(this.reactors.map(function(t){return t.inputs})),_toConsumableArray(this.subflows.map(function(t){return t.consumes})))),n=(e=[]).concat.apply(e,["error","warn","info","debug"].concat(_toConsumableArray(this.reactors.map(function(t){return t.outputs})),_toConsumableArray(this.subflows.map(function(t){return t.produces})))),i=[],a=!0,o=!1,s=void 0;try{for(var u,c=this._imports.values()[Symbol.iterator]();!(a=(u=c.next()).done);a=!0){var l=u.value;l&&(i.push.apply(i,_toConsumableArray(l.consumes)),r.push.apply(r,_toConsumableArray(l.requiresAll)))}}catch(t){o=!0,s=t}finally{try{!a&&c.return&&c.return()}finally{if(o)throw s}}this.state.set("consumes",new Set(r)),this.state.set("produces",new Set(n)),this.state.set("absorbs",new Set(i))}},{key:"in",value:function(){for(var t=arguments.length,e=Array(t),r=0;r<t;r++)e[r]=arguments[r];return this.reactor(e)}},{key:"reactor",value:function t(e,r,n){var t=new KineticReactor({inputs:e,outputs:r,handler:n});return n?this.include(t):t.join(this)}},{key:"inspect",value:function(){return Object.assign(_get(e.prototype.__proto__||Object.getPrototypeOf(e.prototype),"inspect",this).call(this),{label:this._label,summary:this._summary,requires:this.requires,imports:this.imports,subflows:this.subflows.map(function(t){return t.inspect()}),reactors:this.reactors.map(function(t){return t.inspect()})})}},{key:"toJSON",value:function(){return Object.assign(_get(e.prototype.__proto__||Object.getPrototypeOf(e.prototype),"toJSON",this).call(this),{label:this._label,summary:this._summary,requires:this.requires,imports:this.imports,subflows:this.subflows.map(function(t){return t.toJSON()}),reactors:this.reactors.map(function(t){return t.toJSON()})})}},{key:"ready",get:function(){return this.state.get("ready")}},{key:"intercepts",get:function(){var t,e=Array.from(this._imports.values()).filter(Boolean),r=(t=[]).concat.apply(t,_toConsumableArray(e.map(function(t){return t.inputs})));return new Set(r)}},{key:"identity",get:function(){var t=this.state.get("parent");return t?t.identity+"/"+this.label:this.label}},{key:"label",get:function(){return this._label}},{key:"requires",get:function(){return Array.from(this._requires)}},{key:"subflows",get:function(){return Array.from(this._subflows)}},{key:"reactors",get:function(){return Array.from(this._reactors)}},{key:"imports",get:function(){return Array.from(this._imports).map(function(t){var e=_slicedToArray(t,2),r=e[0];return e[1]||r})}},{key:"consumes",get:function(){return Array.from(this.state.get("consumes"))}},{key:"produces",get:function(){return Array.from(this.state.get("produces"))}},{key:"absorbs",get:function(){return Array.from(this.state.get("absorbs"))}},{key:"inputs",get:function(){var t,e=new Set((t=[]).concat.apply(t,_toConsumableArray(this.reactors.map(function(t){return t.inputs}))));return Array.from(e)}},{key:"outputs",get:function(){var t,e=new Set((t=[]).concat.apply(t,_toConsumableArray(this.reactors.map(function(t){return t.outputs}))));return Array.from(e)}},{key:"requiresAll",get:function(){var t,e=(t=[]).concat.apply(t,[this.requires].concat(_toConsumableArray(this.subflows.map(function(t){return t.requiresAll})))),r=!0,n=!1,i=void 0;try{for(var a,o=this._imports.values()[Symbol.iterator]();!(r=(a=o.next()).done);r=!0){var s=a.value;s&&e.push.apply(e,_toConsumableArray(s.requiresAll))}}catch(t){n=!0,i=t}finally{try{!r&&o.return&&o.return()}finally{if(n)throw i}}return Array.from(new Set(e))}}]),e}(KineticEssence);module.exports=KineticObjectStream;
},{"./essence":10,"./reactor":12,"debug":21}],14:[function(require,module,exports){
(function (global){
"use strict";var kos=require("./lib/core");kos.Stream=require("./lib/stream"),kos.Reactor=require("./lib/reactor"),kos.Essence=require("./lib/essence"),global.kos=module.exports=kos.default=kos.kos=kos;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
...
},{"./_stream_duplex":34,"./internal/streams/BufferList":39,"_process":32,"buffer":18,"buffer-shims":17,"core-util-is":20,"events":24,"inherits":26,"isarray":28,"process-nextick-args":31,"stream":44,"string_decoder/":45,"util":16}],37:[function(require,module,exports){
...
},{"./_stream_duplex":34,"_process":32,"buffer":18,"buffer-shims":17,"core-util-is":20,"events":24,"inherits":26,"process-nextick-args":31,"stream":44,"util-deprecate":46}],39:[function(require,module,exports){
...
},{"./lib/_stream_duplex.js":34,"./lib/_stream_passthrough.js":35,"./lib/_stream_readable.js":36,"./lib/_stream_transform.js":37,"./lib/_stream_writable.js":38,"_process":32,"stream":44}],42:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var kos=require("./node"),link=require("./flows/link"),sync=require("./flows/sync"),http=require("./flows/http"),ws=require("./flows/ws");exports.default=kos,exports.link=link,exports.sync=sync,exports.http=http,exports.ws=ws;
