...
(function (__dirname){
"use strict";function loadReactor(e){var o=this.fetch("module/path"),r={},t=[o.resolve(e),o.resolve(o.join("reactors",e)),o.resolve(__dirname,o.join("reactors",e)),e],a=!0,i=!1,n=void 0;try{for(var s,c=t[Symbol.iterator]();!(a=(s=c.next()).done);a=!0){var u=s.value;try{r=require(u);break}catch(e){if("MODULE_NOT_FOUND"!==e.code)throw e}}}catch(e){i=!0,n=e}finally{try{!a&&c.return&&c.return()}finally{if(i)throw n}}if(r.type!==Symbol.for("kinetic.reactor"))throw new Error("unable to load KOS for "+e+" from "+t);this.send("reactor",r)}function chainReactor(e){var o=this.fetch("reactors");this.parent.chain(e),o.set(e.label,e)}function setupLogger(e){var o=e.verbose,r=void 0===o?0:o,t=e.silent;if(void 0===t||!t){var a=this.fetch("module/debug"),i=["kos:error","kos:warn"];r&&i.push("kos:info"),r>1&&i.push("kos:debug"),r>2&&i.push("kos:trace"),a.enable(i.join(","));var n=a("kos:error"),s=a("kos:warn"),c=a("kos:info"),u=a("kos:debug"),l=a("kos:trace");this.get("initialized")||(this.parent.on("data",function(e){var o=e.key,t=e.value;switch(o){case"error":n(r>1?t:t.message);break;case"warn":s(t.join(" "));break;case"info":c(t.join(" "));break;case"debug":u(t.join(" "));break;default:switch(void 0===t?"undefined":_typeof(t)){case"function":case"object":l("%s\n%O\n",o,t);break;default:l("%s %o",o,t)}}}),this.set("initialized",!0))}}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},kos=require("..");module.exports=kos.reactor("core","Provides KOS reactor loading & logging facility").setState("reactors",new Map).in("load").out("reactor").use("module/path").bind(loadReactor).in("reactor").out("load").bind(chainReactor).in("log").use("module/debug").bind(setupLogger);
}).call(this,"/reactors")
},{"..":undefined}],44:[function(require,module,exports){
(function (global){
"use strict";function simpleGet(t){this.send("http/request",{url:t,method:"GET"})}function clientRequest(t){var e=this,s=this.fetch("module/superagent"),r=t.url,o=t.method,n=t.data;switch(o.toLowerCase()){case"get":case"delete":s[o](r).end(function(t,s){t?e.throw(t):e.send("http/response",s)});break;case"post":case"put":case"patch":s[o](r).send(n).end(function(t,s){t?e.throw(t):e.send("http/response",s)})}}function createServer(t){var e=this,s=this.fetch("module/http"),r=normalizeOptions.call(this,t),o=r.protocol,n=r.hostname,i=r.port,h=s.createServer(function(t,s){e.send("http/server/request",{req:t,res:s})});h.on("connection",function(t){var s=o+"//"+t.remoteAddress+":"+t.remotePort;e.info("accept",s),e.send("http/socket",t),e.send("http/link",{addr:s,socket:t}),t.emit("active")}),h.on("listening",function(){e.info("listening",n,i),e.send("http/server",h)}),h.on("error",this.error.bind(this)),this.debug("attempt",n,i),h.listen(i,n)}function classifyServerTransaction(t){var e=t.req,s=(t.res,e.method.toLowerCase());this.send("http/server/request/"+s,t)}function normalizeOptions(t){if("string"==typeof t){var e=this.fetch("module/url");t.includes("://")||(t="http://"+t),t=e.parse(t,!0)}return{protocol:t.protocol||"http:",hostname:t.hostname||"0.0.0.0",port:parseInt(t.port,10)||80}}function handleRoute(t,e){}function proxy(t,e){t.host=e.host,this.send("http/request",t)}var _global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos;module.exports=kos.reactor("http","Provides HTTP client and server reactions").in("http/request").out("http/response").use("module/superagent").bind(clientRequest).in("http/request/get").out("http/request").bind(simpleGet).in("http/listen").out("http/server","http/socket","link","http/server/request").use("module/http").bind(createServer).in("http/server/request").out("http/server/request/*").bind(classifyServerTransaction).in("http/server","http/route").out("http/server/request").bind(handleRoute);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined}],45:[function(require,module,exports){
(function (global){
"use strict";function connect(e){switch(e.protocol){case"ws:":case"wss:":this.send("ws/connect",e);break;case"tcp:":case"udp:":case void 0:this.send("net/connect",e);break;default:this.warn("unsupported protocol",e.protocol)}}function listen(e){switch(e.protocol){case"ws:":case"wss:":this.send("ws/listen",e);break;case"tcp:":case"udp:":case void 0:this.send("net/listen",e);break;default:this.warn("unsupported protocol",e.protocol)}}function connectByUrl(e){var n=this.get("module/url"),t=n.parse(e,!0);t.protocol||(t=n.parse("tcp:"+e,!0)),this.send("link/connect",Object.assign(t,t.query))}function listenByUrl(e){var n=this.get("module/url"),t=n.parse(e,!0);t.protocol||(t=n.parse("tcp:"+e,!0)),this.send("link/listen",Object.assign(t,t.query))}function createLinkStream(e){var n=this,t=e.addr,s=e.socket,o=this.fetch("streams"),i=o.has(t)?o.get(t):new kos.Stream;s.on("active",function(){var e=i.io();s.pipe(e,{end:!1}).pipe(s),s.on("close",function(){e.unpipe(s),s.destroy()})}),o.has(t)||(i.on("ready",function(){return n.debug("ready now!")}),o.set(t,i),this.send("link/stream",i))}var _global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos,netReactor=require("./net"),wsReactor=require("./ws");module.exports=kos.reactor("link","Provides dynamic client/server communication flows for various protocols").embed(netReactor,wsReactor).setState("streams",new Map).in("link/connect").out("net/connect","ws/connect").bind(connect).in("link/listen").out("net/listen","ws/listen").bind(listen).in("link/connect/url").out("link/connect").use("module/url").bind(connectByUrl).in("link/listen/url").out("link/listen").use("module/url").bind(listenByUrl).in("link").out("link/stream").bind(createLinkStream);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined,"./net":46,"./ws":48}],46:[function(require,module,exports){
(function (global){
"use strict";function ready(t,e){}function connect(t){var e=this,n=this.fetch("module/net","protocols"),o=_slicedToArray(n,2),r=o[0],i=o[1],s=normalizeOptions.call(this,t),c=s.protocol,l=s.hostname,a=s.port,u=s.retry,d=s.max;if(!i.includes(c))return this.error("unsupported protocol",c);var p=c+"//"+l+":"+a,m=new r.Socket;this.send("link",{addr:p,socket:m}),m.setNoDelay(),m.on("connect",function(){e.info("connected to",p),e.send("net/socket",m),m.emit("active"),u&&(u=100)}),m.on("close",function(){m.closing||u&&setTimeout(function(){e.debug("attempt reconnect",p),e.send("net/connect",Object.assign({},t,{retry:Math.round(Math.min(d,1.5*u))}),null)},u)}),m.on("error",this.error.bind(this)),this.debug("attempt",p),m.connect(a,l)}function listen(t){var e=this,n=this.fetch("module/net"),o=normalizeOptions(t),r=o.protocol,i=o.hostname,s=o.port,c=(o.retry,o.max,n.createServer(function(t){var n=r+"//"+t.remoteAddress+":"+t.remotePort;e.info("accept",n),e.send("net/socket",t),e.send("link",{addr:n,socket:t}),t.emit("active")}));c.on("listening",function(){e.info("listening",i,s),e.send("net/server",c)}),c.on("error",this.error.bind(this)),this.debug("attempt",i,s),c.listen(s,i)}function connectByUrl(t){var e=this.fetch("module/url"),n=e.parse(t,!0);n.protocol||(n=e.parse("tcp:"+t,!0)),this.send("net/connect",Object.assign(n,n.query))}function listenByUrl(t){var e=this.fetch("module/url"),n=e.parse(t,!0);n.protocol||(n=e.parse("tcp:"+t,!0)),this.send("net/listen",Object.assign(n,n.query))}function normalizeOptions(t){return{protocol:t.protocol||"tcp:",hostname:t.hostname||"0.0.0.0",port:parseInt(t.port,10)||12345,retry:parseInt(t.retry,10)||100,max:parseInt(t.max,10)||5e3}}var _slicedToArray=function(){function t(t,e){var n=[],o=!0,r=!1,i=void 0;try{for(var s,c=t[Symbol.iterator]();!(o=(s=c.next()).done)&&(n.push(s.value),!e||n.length!==e);o=!0);}catch(t){r=!0,i=t}finally{try{!o&&c.return&&c.return()}finally{if(r)throw i}}return n}return function(e,n){if(Array.isArray(e))return e;if(Symbol.iterator in Object(e))return t(e,n);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos;module.exports=kos.reactor("net","Provides network client/server communication flows").setState("protocols",["tcp:","udp:"]).in("module/net","module/url").bind(ready).in("net/connect").out("net/socket","link","net/connect").use("module/net").bind(connect).in("net/listen").out("net/server","net/socket","link").use("module/net").bind(listen).in("net/connect/url").out("net/connect").use("module/url").bind(connectByUrl).in("net/listen/url").out("net/listen").use("module/url").bind(listenByUrl);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined}],47:[function(require,module,exports){
(function (global){
"use strict";var _global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos,linkReactor=require("./link");module.exports=kos.reactor("sync","Provide dataflow object synchronization with remote stream(s)").embed(linkReactor).in("sync/connect").out("link/connect/url").bind(function(n){this.send("link/connect/url",n)}).in("sync/listen").out("link/listen/url").bind(function(n){this.send("link/listen/url",n)}).in("link/stream").bind(function(n){n.pipe(this.parent).pipe(n)});
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined,"./link":45}],48:[function(require,module,exports){
(function (global){
"use strict";function connect(e){var t=this,o=this.fetch("module/simple-websocket"),s=this.fetch("protocols"),n=normalizeOptions(e),r=n.protocol,i=n.hostname,c=n.port,l=n.path,u=n.retry,a=n.max;if(!s.includes(r))return this.error("unsupported protocol",r);var p=r+"//"+i+":"+c+"/"+l,d=new o(p);this.send("link",{addr:p,socket:d}),d.on("connect",function(){t.info("connected to",p),t.send("ws/socket",d),d.emit("active"),u&&(u=100)}),d.on("close",function(){u&&setTimeout(function(){t.debug("attempt reconnect",p),t.send("ws/connect",Object.assign({},e,{retry:Math.round(Math.min(a,1.5*u))}),null)},u)}),d.on("error",this.error.bind(this))}function listen(e){var t=this,o=this.fetch("module/simple-websocket/server"),s=this.fetch("protocols"),n=normalizeOptions(e),r=n.protocol,i=n.hostname,c=n.port,l=n.path,u=n.server;if(!s.includes(r))return this.error("unsupported protocol",r);u?(u=new o({server:u}),this.info("listening on existing server instance"),this.send("ws/server",u)):(u=new o({host:i,port:c,path:l}),u.on("listening",function(){t.info("listening",i,c,l),t.send("ws/server",u)})),u.on("connection",function(e){var o=e._ws._socket,s=r+"//"+o.remoteAddress+":"+o.remotePort;t.info("accept",s),t.send("ws/socket",e),t.send("link",{addr:s,socket:e}),e.emit("active")}),u.on("error",this.error.bind(this))}function connectByUrl(e){var t=this.fetch("module/url"),o=t.parse(e,!0);o.protocol||(o=t.parse("ws:"+e,!0)),this.send("ws/connect",Object.assign(o,o.query))}function listenByUrl(e){var t=this.fetch("module/url"),o=t.parse(e,!0);o.protocol||(o=t.parse("ws:"+e,!0)),this.send("ws/listen",Object.assign(o,o.query))}function normalizeOptions(e){return{protocol:e.protocol||"ws:",hostname:e.hostname||"0.0.0.0",port:parseInt(e.port,10)||80,path:e.path||"",server:e.server,retry:parseInt(e.retry,10)||100,max:parseInt(e.max,10)||5e3}}var _global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos;module.exports=kos.reactor("ws","Provides WebSocket transactions utilizing 'ws' module").setState("protocols",["ws:","wss:"]).in("ws/connect").out("ws/socket","link","ws/connect").use("module/simple-websocket").bind(connect).in("ws/listen").out("ws/server","ws/socket","link").use("module/simple-websocket/server").bind(listen).in("ws/connect/url").out("ws/connect").use("module/url").bind(connectByUrl).in("ws/listen/url").out("ws/listen").use("module/url").bind(listenByUrl);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined}],49:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var kos=require("./node"),core=require("./reactors/core"),link=require("./reactors/link"),sync=require("./reactors/sync"),http=require("./reactors/http"),ws=require("./reactors/ws");exports.default=kos,exports.link=link,exports.sync=sync,exports.http=http,exports.ws=ws;
