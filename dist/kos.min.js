...
(function (global){
"use strict";function fuse(e){this.parent.load(e)}var KineticStream=require("./lib/stream"),KineticReactor=require("./lib/reactor"),KineticTrigger=require("./lib/trigger"),kos=new KineticReactor({name:"kos",purpose:"primary consumer of chaos",passive:!0,triggers:[{inputs:"reactor",handler:fuse}]});kos.Stream=KineticStream,kos.Reactor=KineticReactor,kos.Trigger=KineticTrigger,global.kos=module.exports=kos.default=kos.kos=kos;
