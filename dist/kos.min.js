...
"use strict";var KineticObjectStream=require("./lib/stream"),KineticReactor=require("./lib/reactor"),KineticEssence=require("./lib/essence"),path=require("path"),kos={load:function(e){var r={},t=[path.resolve(e),path.resolve(path.join("flows",e)),path.resolve(__dirname,path.join("flows",e)),e],n=!0,i=!1,a=void 0;try{for(var o,c=t[Symbol.iterator]();!(n=(o=c.next()).done);n=!0){var l=o.value;try{r=require(l);break}catch(e){if("MODULE_NOT_FOUND"!==e.code)throw e}}}catch(e){i=!0,a=e}finally{try{!n&&c.return&&c.return()}finally{if(i)throw a}}if("KineticObjectStream"!==r.type)throw new Error("unable to load KOS for "+e+" from "+t);return r},create:function(e){return new KineticObjectStream(e)},chain:function(){for(var e=arguments.length,r=Array(e),t=0;t<e;t++)r[t]=arguments[t];var n={};r=r.filter(function(e){return"KineticObjectStream"===e.type});var i=!0,a=!1,o=void 0;try{for(var c,l=r[Symbol.iterator]();!(i=(c=l.next()).done);i=!0){var s=c.value;n[s.label]=s}}catch(e){a=!0,o=e}finally{try{!i&&l.return&&l.return()}finally{if(a)throw o}}r=Object.keys(n).map(function(e){return n[e]});var u=r.shift(),f=r.reduce(function(e,r){return e.pipe(r)},u);return u&&f&&f.pipe(u),[u,f]},filter:function(){for(var e=arguments.length,r=Array(e),t=0;t<e;t++)r[t]=arguments[t];var n=new Set(r);return new KineticEssence({transform:function(e,r,t){e&&e.match(n)?t(null,e):t()}})},Stream:KineticObjectStream,Reactor:KineticReactor,Essence:KineticEssence,DEFAULT_HOST:process.env.KOS_HOST||"127.0.0.1",DEFAULT_PORT:process.env.KOS_PORT||12345};global.kos=module.exports=kos.default=kos.kos=kos;
