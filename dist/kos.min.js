...
"use strict";var delegate=require("delegates"),proto=module.exports={get:function(){for(var e=this,t=arguments.length,r=Array(t),o=0;o<t;o++)r[o]=arguments[o];var d=r.map(function(t){return e.state.has(t)?e.state.get(t):e.parent?e.parent.state.get(t):null});return d.length>1?d:d[0]}};delegate(proto,"trigger").getter("state").getter("inputs").getter("outputs").getter("parent").method("post").method("send").method("debug").method("info").method("warn").method("error").method("throw"),delegate(proto,"state").method("clear").method("delete").method("entries").method("forEach").method("has").method("set").method("keys").method("set").method("values");
},{"delegates":26}],2:[function(require,module,exports){
"use strict";function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,r=Array(e.length);t<e.length;t++)r[t]=e[t];return r}return Array.from(e)}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function extractUniqueKeys(){for(var e=arguments.length,t=Array(e>1?e-1:0),r=1;r<e;r++)t[r-1]=arguments[r];var n=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[],i=n.reduce(function(e,r){return e.concat.apply(e,_toConsumableArray(t.map(function(e){return r[e]})))},[]);return Array.from(new Set(i))}var _get=function e(t,r,n){null===t&&(t=Function.prototype);var i=Object.getOwnPropertyDescriptor(t,r);if(void 0===i){var o=Object.getPrototypeOf(t);return null===o?void 0:e(o,r,n)}if("value"in i)return i.value;var s=i.get;if(void 0!==s)return s.call(n)},_createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),debug=require("debug")("kos:reactor"),KineticStream=require("./stream"),KineticTrigger=require("./trigger"),KINETIC_MAX_RECEIVERS=30,KineticReactor=function(e){function t(e){if(_classCallCheck(this,t),e instanceof t&&(e=e.inspect(),debug(e.name,"cloning")),"string"==typeof e&&(e={name:e}),!e.name)throw new Error("must supply 'name' to create a new KineticReactor");var r=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e)),n=e,i=n.name,o=n.purpose,s=n.reactors,u=void 0===s?[]:s,a=n.triggers,c=void 0===a?[]:a,p=n.maxReceivers,h=void 0===p?KINETIC_MAX_RECEIVERS:p;return r._name=i,r._purpose=o,r._reactors=new Map,r._triggers=new Set,r.core=new KineticStream({maxListeners:h,filter:function(e){var t=[];if(r.seen(e)){if(t.push("accept"),!e.match(r.inputs)&&!e.match(r.requires))return!e.match(["error","warn","info","debug"])&&(t.push("reject"),r.emit("flow",e,t),!1);debug(r.identity,"<==",e.key),r.mark(e,!0),t.push("consume"),e.match(r.absorbs)&&t.push("absorb")}else{if(e.match(["error","warn","info","debug"]))return!0;t.push("feedback"),e.match(r.inputs)?t.push("consume"):t.push("reject"),e.match(r.absorbs)?(debug(r.identity,"<->",e.key),r.mark(e,!0),t.push("absorb")):e.match(r.outputs)?(debug(r.identity,"==>",e.key),t.push("produce")):(debug(r.identity,"<--",e.key),t.push("byproduct"),r.mark(e)),"error"!==e.key&&r.emit(e.key,e.value)}return r.emit("flow",e,t),!0}}),r.pipe(r.core).pipe(r),r.load.apply(r,_toConsumableArray(u)),r.add.apply(r,_toConsumableArray(c)),kos.register(r),debug(r.identity,"new",r.id),r}return _inherits(t,e),_createClass(t,[{key:Symbol.toStringTag,get:function(){return"KineticReactor:"+this.name}}]),_createClass(t,[{key:"desc",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"";return this._purpose=e,this}},{key:"load",value:function(){for(var e=arguments.length,r=Array(e),n=0;n<e;n++)r[n]=arguments[n];var i=!0,o=!1,s=void 0;try{for(var u,a=r[Symbol.iterator]();!(i=(u=a.next()).done);i=!0){var c=u.value;this._reactors.has(c.name)||(c=new t(c).join(this),this._reactors.set(c.name,c),this.core.pipe(c).pipe(this.core))}}catch(e){o=!0,s=e}finally{try{!i&&a.return&&a.return()}finally{if(o)throw s}}return this}},{key:"add",value:function(){for(var e=arguments.length,t=Array(e),r=0;r<e;r++)t[r]=arguments[r];var n=!0,i=!1,o=void 0;try{for(var s,u=t[Symbol.iterator]();!(n=(s=u.next()).done);n=!0){var a=s.value;a=new KineticTrigger(a).join(this),this._triggers.add(a),this.core.pipe(a).pipe(this.core)}}catch(e){i=!0,o=e}finally{try{!n&&u.return&&u.return()}finally{if(i)throw o}}return this}},{key:"chain",value:function(){for(var e=arguments.length,t=Array(e),r=0;r<e;r++)t[r]=arguments[r];var n=t.reduce(function(e,t){return e.pipe(t)},this);return n&&n.pipe(this),this}},{key:"in",value:function(){for(var e=arguments.length,t=Array(e),r=0;r<e;r++)t[r]=arguments[r];return this.trigger(t)}},{key:"trigger",value:function(e,t,r){var n=new KineticTrigger({inputs:e,outputs:t,handler:r});return r?this.include(n):n.join(this)}},{key:"contains",value:function(e){return!!this.triggers.some(function(t){return t.id===e})||!!this.reactors.some(function(t){return t.contains(e)})}},{key:"inspect",value:function(){return Object.assign(_get(t.prototype.__proto__||Object.getPrototypeOf(t.prototype),"inspect",this).call(this),{name:this._name,purpose:this._purpose,requires:this.requires,reactors:this.reactors.map(function(e){return e.inspect()}),triggers:this.triggers.map(function(e){return e.inspect()})})}},{key:"toJSON",value:function(){return Object.assign(_get(t.prototype.__proto__||Object.getPrototypeOf(t.prototype),"toJSON",this).call(this),{name:this._name,purpose:this._purpose,requires:this.requires,reactors:this.reactors.map(function(e){return e.toJSON()}),triggers:this.triggers.map(function(e){return e.toJSON()}),inputs:this.inputs,outputs:this.outputs})}},{key:"identity",get:function(){var e=this.state.get("parent");return e?e.identity+"/"+this.name:this.name}},{key:"type",get:function(){return Symbol.for("kinetic.reactor")}},{key:"name",get:function(){return this._name}},{key:"purpose",get:function(){return this._purpose}},{key:"triggers",get:function(){return Array.from(this._triggers)}},{key:"reactors",get:function(){return Array.from(this._reactors.values())}},{key:"requires",get:function(){return extractUniqueKeys(this.triggers.concat(this.reactors),"requires")}},{key:"inputs",get:function(){return extractUniqueKeys(this.triggers,"inputs","requires")}},{key:"outputs",get:function(){return extractUniqueKeys(this.triggers,"outputs")}},{key:"absorbs",get:function(){return extractUniqueKeys(this.reactors,"inputs")}}]),t}(KineticStream);module.exports=KineticReactor;
},{"./stream":3,"./trigger":5,"debug":24}],3:[function(require,module,exports){
"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}var _createClass=function(){function t(t,e){for(var r=0;r<e.length;r++){var n=e[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(e,r,n){return r&&t(e.prototype,r),n&&t(e,n),e}}(),debug=require("debug")("kos:stream"),uuid=require("uuid"),_require=require("stream"),Transform=_require.Transform,KineticToken=require("./token"),KineticStream=function(t){function e(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};_classCallCheck(this,e),t instanceof e&&(t=t.inspect()),t.objectMode=!0,delete t.transform;var r=_possibleConstructorReturn(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t));return r.id=uuid(),t.filter instanceof Function&&(r.filter=t.filter),t.state instanceof Map?r.state=t.state:r.state=new Map(t.state),r._buffer="",r.on("end",r.warn.bind(r,"kinetic stream died unexpectedly")),t.maxListeners&&r.setMaxListeners(t.maxListeners),r}return _inherits(e,t),_createClass(e,[{key:Symbol.toStringTag,get:function(){return"KineticStream"}}]),_createClass(e,[{key:"clone",value:function(){return new this.constructor(this)}},{key:"_transform",value:function(t,e,r){if(t instanceof KineticToken)!this.seen(t)&&this.filter(t)&&this.push(this.mark(t));else{this._buffer+=t;var n=this._buffer.split(/\r?\n/);n.length&&(this._buffer=n.pop());var i=!0,o=!1,a=void 0;try{for(var s,u=n.filter(Boolean)[Symbol.iterator]();!(i=(s=u.next()).done);i=!0){var c=s.value;try{t=KineticToken.fromKSON(c.trim())}catch(t){this.error(t);continue}this.filter(t)&&this.push(this.mark(t))}}catch(t){o=!0,a=t}finally{try{!i&&u.return&&u.return()}finally{if(o)throw a}}}r()}},{key:"filter",value:function(t){return!0}},{key:"init",value:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"",e=arguments[1];if(t.constructor===Object)for(var r in t)this.state.set(r,t[r]);else this.state.set(t,e);return this}},{key:"seen",value:function(t){return t.tags.has(this.id)}},{key:"mark",value:function(t,e){return t.tag(this.id,e)}},{key:"join",value:function(t){if(!(t instanceof e))throw new Error("[join] can only join to other KineticStreams, sorry",t);return this.parent=t,this}},{key:"feed",value:function(t){for(var e=arguments.length,r=Array(e>1?e-1:0),n=1;n<e;n++)r[n-1]=arguments[n];var i=!0,o=!1,a=void 0;try{for(var s,u=r[Symbol.iterator]();!(i=(s=u.next()).done);i=!0){var c=s.value;this.write(new KineticToken(t,c))}}catch(t){o=!0,a=t}finally{try{!i&&u.return&&u.return()}finally{if(o)throw a}}return this}},{key:"io",value:function(){var t=this,r=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},n=r.passthrough,i=void 0!==n&&n,o=new e({filter:function(e){return debug("io:write",e.key,t),t.write(o.mark(e)),!1}});return this.on("data",function(t){!i&&o.seen(t)||t.match(["module/*","error","warn","info","debug"])||(debug("io:push",t.key),o.push(t.toKSON()+"\n"))}),o.join(this)}},{key:"post",value:function(t,e){if(this.parent){var r=this.parent.state;if(r&&r.has(t)){var n=r.get(t);if(n instanceof Set)return n.add(e)}r.set(t,e)}}},{key:"log",value:function(t){for(var e=arguments.length,r=Array(e>1?e-1:0),n=1;n<e;n++)r[n-1]=arguments[n];this.push(new KineticToken(t,[this.identity].concat(r),this.id))}},{key:"debug",value:function(){this.log.apply(this,["debug"].concat(Array.prototype.slice.call(arguments)))}},{key:"info",value:function(){this.log.apply(this,["info"].concat(Array.prototype.slice.call(arguments)))}},{key:"warn",value:function(){this.log.apply(this,["warn"].concat(Array.prototype.slice.call(arguments)))}},{key:"error",value:function(t){for(var e=arguments.length,r=Array(e>1?e-1:0),n=1;n<e;n++)r[n-1]=arguments[n];return t instanceof Error||(t=new Error([t].concat(r).join(" "))),t.flow=this,this.push(new KineticToken("error",t,this.id)),t}},{key:"inspect",value:function(){return{id:this.id,type:this.type,state:Array.from(this.state)}}},{key:"toJSON",value:function(){var t=this.inspect();return delete t.state,t}},{key:"parent",get:function(){return this.state.get("parent")},set:function(t){return this.state.set("parent",t)}},{key:"type",get:function(){return Symbol.for("kinetic.stream")}},{key:"identity",get:function(){return this.id}},{key:"throw",get:function(){return this.error}}]),e}(Transform);module.exports=KineticStream;
},{"./token":4,"debug":24,"stream":46,"uuid":49}],4:[function(require,module,exports){
"use strict";function _classCallCheck(r,t){if(!(r instanceof t))throw new TypeError("Cannot call a class as a function")}var _slicedToArray=function(){function r(r,t){var e=[],n=!0,a=!1,i=void 0;try{for(var u,l=r[Symbol.iterator]();!(n=(u=l.next()).done)&&(e.push(u.value),!t||e.length!==t);n=!0);}catch(r){a=!0,i=r}finally{try{!n&&l.return&&l.return()}finally{if(a)throw i}}return e}return function(t,e){if(Array.isArray(t))return t;if(Symbol.iterator in Object(t))return r(t,e);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_createClass=function(){function r(r,t){for(var e=0;e<t.length;e++){var n=t[e];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(r,n.key,n)}}return function(t,e,n){return e&&r(t.prototype,e),n&&r(t,n),t}}(),CircularJSON=require("circular-json"),KineticToken=function(){function r(t,e){var n=this;_classCallCheck(this,r),this.key=t,this.value=e,this.tags=new Map;for(var a=arguments.length,i=Array(a>2?a-2:0),u=2;u<a;u++)i[u-2]=arguments[u];i.forEach(function(r){return n.tag(r)})}return _createClass(r,null,[{key:"fromKSON",value:function(t){var e=t.split(/\s+(.+)/),n=_slicedToArray(e,2),a=n[0],i=n[1];if(!a||!i)throw new Error("invalid KSON, must define label and argument");var u=a.split("|"),l=_slicedToArray(u,2),o=l[0],c=l[1];return i=CircularJSON.parse(i),new r(o,i,c)}}]),_createClass(r,[{key:"tag",value:function(r,t){return r&&this.tags.set(r,t),this}},{key:"match",value:function(r){if(Array.isArray(r)&&(r=new Set(r)),!(r instanceof Set))return!1;if(r.has(this.key))return!0;var t=!0,e=!1,n=void 0;try{for(var a,i=r[Symbol.iterator]();!(t=(a=i.next()).done);t=!0){var u=a.value;if(-1!==u.indexOf("*")){var l="^"+u.replace("*",".*")+"$";if(null!=this.key.match(l))return!0}}}catch(r){e=!0,n=r}finally{try{!t&&i.return&&i.return()}finally{if(e)throw n}}return!1}},{key:"toKSON",value:function(){var r=this.key,t=this.value;return r+"|"+this.origin+" "+CircularJSON.stringify(t)}},{key:"toJSON",value:function(){var r=this.key,t=this.value;return"function"==typeof t&&(t=null),'{"'+r+'":'+CircularJSON.stringify(t)+"}"}},{key:"origin",get:function(){return this.tags.keys().next().value}},{key:"accepted",get:function(){var r=!0,t=!1,e=void 0;try{for(var n,a=this.tags.values()[Symbol.iterator]();!(r=(n=a.next()).done);r=!0){if(n.value)return!0}}catch(r){t=!0,e=r}finally{try{!r&&a.return&&a.return()}finally{if(t)throw e}}return!1}}]),r}();module.exports=KineticToken;
},{"circular-json":11}],5:[function(require,module,exports){
"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}var _get=function t(e,r,n){null===e&&(e=Function.prototype);var i=Object.getOwnPropertyDescriptor(e,r);if(void 0===i){var o=Object.getPrototypeOf(e);return null===o?void 0:t(o,r,n)}if("value"in i)return i.value;var u=i.get;if(void 0!==u)return u.call(n)},_createClass=function(){function t(t,e){for(var r=0;r<e.length;r++){var n=e[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(e,r,n){return r&&t(e.prototype,r),n&&t(e,n),e}}(),debug=require("debug")("kos:trigger"),KineticStream=require("./stream"),KineticToken=require("./token"),KineticContext=require("./context"),KineticTrigger=function(t){function e(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};_classCallCheck(this,e);var r=_possibleConstructorReturn(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t)),n=t.inputs,i=void 0===n?[]:n,o=t.outputs,u=void 0===o?[]:o,a=t.requires,s=void 0===a?[]:a,c=t.handler,h=void 0===c?e.none:c;return i&&!Array.isArray(i)&&(i=[i]),u&&!Array.isArray(u)&&(u=[u]),r._inputs=new Set(i),r._outputs=new Set(u),r._requires=new Set(s),r._handler=h,r}return _inherits(e,t),_createClass(e,[{key:Symbol.toStringTag,get:function(){return"KineticTrigger"}}],[{key:"none",value:function(){}}]),_createClass(e,[{key:"filter",value:function(t){var r=this;if(this.handler===e.none)return!1;if(this.ready(t)){var n=this.context;n.event=t.key,n.arguments=this.inputs.map(function(t){return r.state.get(t)}),debug(this.identity,"ƒ("+this.inputs+")"),this.parent&&this.parent.emit("fire",this);try{this.handler.apply(n,n.arguments)}catch(t){debug(t),this.error(t)}}return!1}},{key:"ready",value:function(t){var e=this;return t.match(this._requires)&&(this.mark(t,!0),this.state.set(t.key,t.value)),!(!this.requires.every(function(t){return e.state.has(t)})||!t.match(this._inputs))&&(this.mark(t,!0),this.state.set(t.key,t.value),this.inputs.every(function(t){return e.state.has(t)}))}},{key:"in",value:function(){for(var t=arguments.length,e=Array(t),r=0;r<t;r++)e[r]=arguments[r];var n=!0,i=!1,o=void 0;try{for(var u,a=e.filter(String)[Symbol.iterator]();!(n=(u=a.next()).done);n=!0){var s=u.value;this._inputs.add(s)}}catch(t){i=!0,o=t}finally{try{!n&&a.return&&a.return()}finally{if(i)throw o}}return this}},{key:"out",value:function(){for(var t=arguments.length,e=Array(t),r=0;r<t;r++)e[r]=arguments[r];var n=!0,i=!1,o=void 0;try{for(var u,a=e.filter(String)[Symbol.iterator]();!(n=(u=a.next()).done);n=!0){var s=u.value;this._outputs.add(s)}}catch(t){i=!0,o=t}finally{try{!n&&a.return&&a.return()}finally{if(i)throw o}}return this}},{key:"has",value:function(){for(var t=arguments.length,e=Array(t),r=0;r<t;r++)e[r]=arguments[r];var n=!0,i=!1,o=void 0;try{for(var u,a=e.filter(String)[Symbol.iterator]();!(n=(u=a.next()).done);n=!0){var s=u.value;this._requires.add(s)}}catch(t){i=!0,o=t}finally{try{!n&&a.return&&a.return()}finally{if(i)throw o}}return this}},{key:"bind",value:function(t){if("function"!=typeof t)throw new Error("[bind] expected function but got something else");return this._handler=t,this.parent?this.parent.add(this):this}},{key:"send",value:function(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{},n=r.id,i=void 0===n?this.id:n,o=r.force,u=void 0!==o&&o,a=new KineticToken(t,e,i);if(!a.match(this._outputs)&&!u)throw new Error("[KineticTrigger:send] "+t+" not in ["+this.outputs+"]");return this.push(a)}},{key:"inspect",value:function(){return Object.assign(_get(e.prototype.__proto__||Object.getPrototypeOf(e.prototype),"inspect",this).call(this),{name:this.name,inputs:this.inputs,outputs:this.outputs,requires:this.requires,handler:this.handler})}},{key:"and",get:function(){return this}},{key:"type",get:function(){return Symbol.for("kinetic.trigger")}},{key:"inputs",get:function(){return Array.from(this._inputs)}},{key:"outputs",get:function(){return Array.from(this._outputs)}},{key:"requires",get:function(){return Array.from(this._requires)}},{key:"handler",get:function(){return this._handler}},{key:"context",get:function(){var t=Object.create(KineticContext);return t.trigger=this,t}},{key:"name",get:function(){return this.handler.name}},{key:"identity",get:function(){return this.parent?this.parent.identity+":"+this.handler.name:this.handler.name}}]),e}(KineticStream);module.exports=KineticTrigger;
},{"./context":1,"./stream":3,"./token":4,"debug":24}],6:[function(require,module,exports){
(function (global){
"use strict";var KineticStream=require("./lib/stream"),KineticReactor=require("./lib/reactor"),KineticTrigger=require("./lib/trigger"),kos={reactor:function(){return new(Function.prototype.bind.apply(KineticReactor,[null].concat(Array.prototype.slice.call(arguments))))},reactors:new Map,register:function(e){e instanceof KineticReactor&&kos.reactors.set(e.id,e)},Stream:KineticStream,Reactor:KineticReactor,Trigger:KineticTrigger};global.kos=module.exports=kos.default=kos.kos=kos;
...
module.exports=function(o,r){var t="";o=o||"Run the trap, drop the bass",o=o.split("");var a={a:["@","Ą","Ⱥ","Ʌ","Δ","Λ","Д"],b:["ß","Ɓ","Ƀ","ɮ","β","฿"],c:["©","Ȼ","Ͼ"],d:["Ð","Ɗ","Ԁ","ԁ","Ԃ","ԃ"],e:["Ë","ĕ","Ǝ","ɘ","Σ","ξ","Ҽ","੬"],f:["Ӻ"],g:["ɢ"],h:["Ħ","ƕ","Ң","Һ","Ӈ","Ԋ"],i:["༏"],j:["Ĵ"],k:["ĸ","Ҡ","Ӄ","Ԟ"],l:["Ĺ"],m:["ʍ","Ӎ","ӎ","Ԡ","ԡ","൩"],n:["Ñ","ŋ","Ɲ","Ͷ","Π","Ҋ"],o:["Ø","õ","ø","Ǿ","ʘ","Ѻ","ם","۝","๏"],p:["Ƿ","Ҏ"],q:["্"],r:["®","Ʀ","Ȑ","Ɍ","ʀ","Я"],s:["§","Ϟ","ϟ","Ϩ"],t:["Ł","Ŧ","ͳ"],u:["Ʊ","Ս"],v:["ט"],w:["Ш","Ѡ","Ѽ","൰"],x:["Ҳ","Ӿ","Ӽ","ӽ"],y:["¥","Ұ","Ӌ"],z:["Ƶ","ɀ"]};return o.forEach(function(o){o=o.toLowerCase();var r=a[o]||[" "],e=Math.floor(Math.random()*r.length);void 0!==a[o]?t+=a[o][e]:t+=o}),t};
},{}],14:[function(require,module,exports){
module.exports=function(i,n){function o(i){return Math.floor(Math.random()*i)}function d(i){var n=!1;return u.filter(function(o){n=o===i}),n}i=i||"   he is here   ";var r={up:["̍","̎","̄","̅","̿","̑","̆","̐","͒","͗","͑","̇","̈","̊","͂","̓","̈","͊","͋","͌","̃","̂","̌","͐","̀","́","̋","̏","̒","̓","̔","̽","̉","ͣ","ͤ","ͥ","ͦ","ͧ","ͨ","ͩ","ͪ","ͫ","ͬ","ͭ","ͮ","ͯ","̾","͛","͆","̚"],down:["̖","̗","̘","̙","̜","̝","̞","̟","̠","̤","̥","̦","̩","̪","̫","̬","̭","̮","̯","̰","̱","̲","̳","̹","̺","̻","̼","ͅ","͇","͈","͉","͍","͎","͓","͔","͕","͖","͙","͚","̣"],mid:["̕","̛","̀","́","͘","̡","̢","̧","̨","̴","̵","̶","͜","͝","͞","͟","͠","͢","̸","̷","͡"," ҉"]},u=[].concat(r.up,r.down,r.mid);return function(i,n){var u,e,t="";n=n||{},n.up=void 0===n.up||n.up,n.mid=void 0===n.mid||n.mid,n.down=void 0===n.down||n.down,n.size=void 0!==n.size?n.size:"maxi",i=i.split("");for(e in i)if(!d(e)){switch(t+=i[e],u={up:0,down:0,mid:0},n.size){case"mini":u.up=o(8),u.mid=o(2),u.down=o(8);break;case"maxi":u.up=o(16)+3,u.mid=o(4)+1,u.down=o(64)+3;break;default:u.up=o(8)+1,u.mid=o(6)/2,u.down=o(8)+1}var a=["up","mid","down"];for(var m in a)for(var f=a[m],p=0;p<=u[f];p++)n[f]&&(t+=r[f][o(r[f].length)])}return t}(i,n)};
},{}],15:[function(require,module,exports){
var colors=require("./colors");module.exports=function(){function o(o){var t=["__defineGetter__","__defineSetter__","__lookupGetter__","__lookupSetter__","charAt","constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf","charCodeAt","indexOf","lastIndexof","length","localeCompare","match","replace","search","slice","split","substring","toLocaleLowerCase","toLocaleUpperCase","toLowerCase","toUpperCase","trim","trimLeft","trimRight"];Object.keys(o).forEach(function(e){-1!==t.indexOf(e)?console.log("warn: ".red+("String.prototype"+e).magenta+" is probably something you don't want to override. Ignoring style name"):"string"==typeof o[e]?(colors[e]=colors[o[e]],r(e,function(){return colors[o[e]](this)})):r(e,function(){for(var r=this,t=0;t<o[e].length;t++)r=colors[o[e][t]](r);return r})})}var r=function(o,r){String.prototype.__defineGetter__(o,r)};r("strip",function(){return colors.strip(this)}),r("stripColors",function(){return colors.strip(this)}),r("trap",function(){return colors.trap(this)}),r("zalgo",function(){return colors.zalgo(this)}),r("zebra",function(){return colors.zebra(this)}),r("rainbow",function(){return colors.rainbow(this)}),r("random",function(){return colors.random(this)}),r("america",function(){return colors.america(this)}),Object.keys(colors.styles).forEach(function(o){r(o,function(){return colors.stylize(this,o)})}),colors.setTheme=function(r){if("string"==typeof r)try{return colors.themes[r]=require(r),o(colors.themes[r]),colors.themes[r]}catch(o){return console.log(o),o}else o(r)}};
...
(function (process){
var argv=process.argv;module.exports=function(){return-1===argv.indexOf("--no-color")&&-1===argv.indexOf("--color=false")&&(-1!==argv.indexOf("--color")||-1!==argv.indexOf("--color=true")||-1!==argv.indexOf("--color=always")||!(process.stdout&&!process.stdout.isTTY)&&("win32"===process.platform||("COLORTERM"in process.env||"dumb"!==process.env.TERM&&!!/^screen|^xterm|^vt100|color|ansi|cygwin|linux/i.test(process.env.TERM))))}();
...
},{"./_stream_duplex":36,"./internal/streams/BufferList":41,"_process":34,"buffer":10,"buffer-shims":9,"core-util-is":23,"events":27,"inherits":29,"isarray":31,"process-nextick-args":33,"stream":46,"string_decoder/":47,"util":8}],39:[function(require,module,exports){
...
},{"./_stream_duplex":36,"_process":34,"buffer":10,"buffer-shims":9,"core-util-is":23,"events":27,"inherits":29,"process-nextick-args":33,"stream":46,"util-deprecate":48}],41:[function(require,module,exports){
...
},{"./lib/_stream_duplex.js":36,"./lib/_stream_passthrough.js":37,"./lib/_stream_readable.js":38,"./lib/_stream_transform.js":39,"./lib/_stream_writable.js":40,"_process":34,"stream":46}],44:[function(require,module,exports){
...
"use strict";function _toConsumableArray(r){if(Array.isArray(r)){for(var e=0,t=Array(r.length);e<r.length;e++)t[e]=r[e];return t}return Array.from(r)}function initialize(r){this.send("reactor",this.parent)}function start(r,e){var t=this,o=this.parent,n=e.stdin,i=e.stdout,a=e.stderr,s=r.args,u=r.expr,c=r.data,d=r.show,l=r.silent,h=r.verbose,p=void 0===h?0:h,f=o.inputs.concat(["module/*","debug/level","error","warn","info","debug"]);if(o.on("flow",function(r){o.emit("clear"),r.origin!==o.id&&(r.match(f)||i.write(r.toKSON()+"\n"))}),this.send("debug/level",l?-1:p),this.info("starting KOS..."),s.forEach(function(r){return t.send("load",r)}),u.forEach(function(r){return o.core.write(r+"\n")}),c.forEach(function(r){return t.send("read",r)}),d)return void this.send("show",a);n.isTTY?this.send("prompt","kos> "):n.pipe(o.core,{end:!1})}function loadReactor(r){var e=this.get("module/path"),t={},o=[e.resolve(r),e.resolve(e.join("reactors",r)),e.resolve(__dirname,r),r],n=!0,i=!1,a=void 0;try{for(var s,u=o[Symbol.iterator]();!(n=(s=u.next()).done);n=!0){var c=s.value;try{t=require(c);break}catch(r){if("MODULE_NOT_FOUND"!==r.code)throw r}}}catch(r){i=!0,a=r}finally{try{!n&&u.return&&u.return()}finally{if(i)throw a}}if(t.type!==Symbol.for("kinetic.reactor"))throw new Error("unable to load KOS for "+r+" from "+o);this.send("reactor",t)}function requireReactor(r){var e=this,t=this.parent;"core"!==r.name&&t.load(r),r.requires.forEach(function(r){var t=r.match(/^module\/(.+)$/,"$1");t&&e.send("require",t[1])})}function readKSONFile(r){var e=this.parent,t=this.get("module/fs"),o=t.createReadStream(r);o.on("error",this.error.bind(this)),o.pipe(e,{end:!1})}function tryRequire(r){var e=this.get("modules");"string"==typeof r&&(r={name:r});var t=r,o=t.name,n=t.path;try{var i=e.get(o)||require(n||o);e.has(o)||e.set(o,i),this.send("module/"+o,i)}catch(r){r.target=o,this.send("require/error",r)}}function promptUser(r){function e(){o.clearLine(a,-1),o.cursorTo(a,0),process.nextTick(function(){return s.prompt()})}var t=this.parent,o=this.get("module/readline"),n=this.get("process"),i=n.stdin,a=(n.stdout,n.stderr);if(!this.get("active")){var s=o.createInterface({input:i,output:a,prompt:colors.grey(r),completer:function(r){var e,o=(e=t.inputs).concat.apply(e,_toConsumableArray(t.reactors.map(function(r){return r.inputs}))),n=Array.from(new Set(o)).sort().concat(".help",".quit"),i=n.filter(function(e){return 0===e.indexOf(r)});return/\s+$/.test(r)&&(n=[]),[i.length?i:n,r]}});s.on("line",function(r){var e=r.trim();switch(e){case"":break;case".help":console.error("sorry, you're on your own for now...");break;case".quit":process.exit(0);break;default:t.core.write(e+"\n")}s.prompt()}),t.on("data",e),t.on("clear",e),this.set("active",!0),s.prompt()}}function outputTreeReactor(r){this.get("show").write(r+"\n")}var _global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos,debug=require("./debug"),render=require("./render"),colors=require("colors");module.exports=kos.reactor("core").desc("reactions to runtime instantiation context").load(debug,render).init("modules",new Map).in("process").out("reactor").bind(initialize).in("program","process").out("reactor","debug/level","load","read","show","prompt").bind(start).in("prompt").and.has("process","module/readline").bind(promptUser).in("load").and.has("module/path").out("reactor").bind(loadReactor).in("require").out("module/*","require/error").bind(tryRequire).in("read").and.has("module/fs").bind(readKSONFile).in("reactor").out("require").bind(requireReactor).in("reactor/tree").and.has("show").bind(outputTreeReactor);
...
(function (global){
"use strict";function setupLogger(e){var o=this.get("loggers");if(!(e<0)){var t=this.get("module/debug"),s=["kos:error","kos:warn"];e&&s.push("kos:info"),e>1&&s.push("kos:debug"),e>2&&s.push("kos:trace"),t.enable(s.join(",")),o.set("error",t("kos:error")),o.set("warn",t("kos:warn")),o.set("info",t("kos:info")),o.set("debug",t("kos:debug")),o.set("trace",t("kos:trace")),e>2&&!this.get("tracing")&&(this.parent.on("data",function(e){var t=o.get("trace"),s=e.key,n=e.value;switch(void 0===n?"undefined":_typeof(n)){case"function":case"object":t("%s\n%O\n",s,n);break;default:t("%s %o",s,n)}}),this.set("tracing",!0))}}function outputError(e){var o=this.get("loggers").get("error"),t=this.get("debug/level");"function"==typeof o&&o(t>1?e:e.message)}function outputMessage(e){var o=this.get("loggers").get(this.event);"function"==typeof o&&o(e.join(" "))}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},_global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos;module.exports=kos.reactor("debug").desc("reactions to send debugging messages to an output stream").init("loggers",new Map).in("debug/level").and.has("module/debug").bind(setupLogger).in("error").and.has("debug/level").bind(outputError).in("warn").bind(outputMessage).in("info").bind(outputMessage).in("debug").bind(outputMessage);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined}],56:[function(require,module,exports){
(function (global){
"use strict";function simpleGet(t){this.send("http/request",{url:t,method:"GET"})}function clientRequest(t){var e=this,s=this.get("module/superagent"),r=t.url,o=t.method,n=t.data;switch(o=o.toLowerCase()){case"get":case"delete":s[o](r).end(function(t,s){t?e.throw(t):e.send("http/response",s)});break;case"post":case"put":case"patch":s[o](r).send(n).end(function(t,s){t?e.throw(t):e.send("http/response",s)})}}function createServer(t){var e=this,s=this.get("module/http"),r=normalizeOptions.call(this,t),o=r.protocol,n=r.hostname,i=r.port,h=s.createServer(function(t,s){e.send("http/server/request",{req:t,res:s})});h.on("connection",function(t){var s=o+"//"+t.remoteAddress+":"+t.remotePort;e.info("accept",s),e.send("http/socket",t),e.send("http/link",{addr:s,socket:t}),t.emit("active")}),h.on("listening",function(){e.info("listening",n,i),e.send("http/server",h)}),h.on("error",this.error.bind(this)),this.debug("attempt",n,i),h.listen(i,n)}function classifyServerTransaction(t){var e=t.req,s=(t.res,e.method.toLowerCase());this.send("http/server/request/"+s,t)}function normalizeOptions(t){if("string"==typeof t){var e=this.get("module/url");t.includes("://")||(t="http://"+t),t=e.parse(t,!0)}return{protocol:t.protocol||"http:",hostname:t.hostname||"0.0.0.0",port:parseInt(t.port,10)||80}}function handleRoute(t,e){}function proxy(t,e){t.host=e.host,this.send("http/request",t)}var _global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos;module.exports=kos.reactor("http").desc("reactions to HTTP client/server requests").in("http/request").and.has("module/superagent").out("http/response").bind(clientRequest).in("http/request/get").out("http/request").bind(simpleGet).in("http/listen").and.has("module/http").out("http/server","http/socket","link","http/server/request").bind(createServer).in("http/server/request").out("http/server/request/*").bind(classifyServerTransaction).in("http/server","http/route").out("http/server/request").bind(handleRoute);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined}],57:[function(require,module,exports){
(function (global){
"use strict";function connect(e){switch(e.protocol){case"ws:":case"wss:":this.send("ws/connect",e);break;case"tcp:":case"udp:":case void 0:this.send("net/connect",e);break;default:this.warn("unsupported protocol",e.protocol)}}function listen(e){switch(e.protocol){case"ws:":case"wss:":this.send("ws/listen",e);break;case"tcp:":case"udp:":case void 0:this.send("net/listen",e);break;default:this.warn("unsupported protocol",e.protocol)}}function connectByUrl(e){var n=this.get("module/url"),s=n.parse(e,!0);s.slashes||(s=n.parse("tcp://"+e,!0)),this.send("link/connect",Object.assign(s,s.query))}function listenByUrl(e){var n=this.get("module/url"),s=n.parse(e,!0);s.slashes||(s=n.parse("tcp://"+e,!0)),this.send("link/listen",Object.assign(s,s.query))}function createLinkStream(e){var n=e.addr,s=e.socket,t=this.get("streams"),i=t.has(n)?t.get(n):new kos.Stream;s.on("active",function(){var e=i.io();s.pipe(e,{end:!1}).pipe(s),s.on("close",function(){e.unpipe(s),s.destroy()}),i.emit("active",s)}),t.has(n)||(t.set(n,i),this.send("link/stream",i))}var _global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos,net=require("./net"),ws=require("./ws");module.exports=kos.reactor("link").desc("reactions to stream dynamic client/server links").load(net,ws).init("streams",new Map).in("link/connect").out("net/connect","ws/connect").bind(connect).in("link/listen").out("net/listen","ws/listen").bind(listen).in("link/connect/url").and.has("module/url").out("link/connect").bind(connectByUrl).in("link/listen/url").and.has("module/url").out("link/listen").bind(listenByUrl).in("link").out("link/stream").bind(createLinkStream);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined,"./net":58,"./ws":63}],58:[function(require,module,exports){
(function (global){
"use strict";function connect(t){var e=this,n=this.get("module/net","protocols"),o=_slicedToArray(n,2),r=o[0],i=o[1],s=normalizeOptions.call(this,t),c=s.protocol,l=s.hostname,a=s.port,u=s.retry,d=s.max;if(!i.includes(c))return this.error("unsupported protocol",c);var p=c+"//"+l+":"+a,h=new r.Socket;this.send("link",{addr:p,socket:h}),h.setNoDelay(),h.on("connect",function(){e.info("connected to",p),e.send("net/socket",h),h.emit("active"),u&&(u=100)}),h.on("close",function(){h.closing||u&&setTimeout(function(){t=Object.assign({},t,{retry:Math.round(Math.min(d,1.5*u))}),e.debug("attempt reconnect",p),e.send("net/connect",t,{id:null})},u)}),h.on("error",this.error.bind(this)),this.debug("attempt",p),h.connect(a,l)}function listen(t){var e=this,n=this.get("module/net"),o=normalizeOptions(t),r=o.protocol,i=o.hostname,s=o.port,c=(o.retry,o.max,n.createServer(function(t){var n=r+"//"+t.remoteAddress+":"+t.remotePort;e.info("accept",n),e.send("net/socket",t),e.send("link",{addr:n,socket:t}),t.emit("active")}));c.on("listening",function(){e.info("listening",i,s),e.send("net/server",c)}),c.on("error",this.error.bind(this)),this.debug("attempt",i,s),c.listen(s,i)}function connectByUrl(t){var e=this.get("module/url"),n=e.parse(t,!0);n.slashes||(n=e.parse("tcp://"+t,!0)),this.send("net/connect",Object.assign(n,n.query))}function listenByUrl(t){var e=this.get("module/url"),n=e.parse(t,!0);n.slashes||(n=e.parse("tcp://"+t,!0)),this.send("net/listen",Object.assign(n,n.query))}function normalizeOptions(t){return{protocol:t.protocol||"tcp:",hostname:t.hostname||"0.0.0.0",port:parseInt(t.port,10)||12345,retry:parseInt(t.retry,10)||100,max:parseInt(t.max,10)||5e3}}var _slicedToArray=function(){function t(t,e){var n=[],o=!0,r=!1,i=void 0;try{for(var s,c=t[Symbol.iterator]();!(o=(s=c.next()).done)&&(n.push(s.value),!e||n.length!==e);o=!0);}catch(t){r=!0,i=t}finally{try{!o&&c.return&&c.return()}finally{if(r)throw i}}return n}return function(e,n){if(Array.isArray(e))return e;if(Symbol.iterator in Object(e))return t(e,n);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos;module.exports=kos.reactor("net").desc("reactions to establish TCP/UDP client/server communication links").init("protocols",["tcp:","udp:"]).in("net/connect").and.has("module/net").out("net/socket","link","net/connect").bind(connect).in("net/listen").and.has("module/net").out("net/server","net/socket","link").bind(listen).in("net/connect/url").and.has("module/url").out("net/connect").bind(connectByUrl).in("net/listen/url").and.has("module/url").out("net/listen").bind(listenByUrl);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined}],59:[function(require,module,exports){
(function (global){
"use strict";var _global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos,link=require("./link");module.exports=kos.reactor("pull").desc("reactions to pull dataflow objects from remote stream(s)").load(link).in("pull/connect").out("link/connect/url").bind(function(l){this.send("link/connect/url",l)}).in("pull/listen").out("link/listen/url").bind(function(l){this.send("link/listen/url",l)}).in("link/stream").bind(function(l){l.pipe(this.parent)});
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined,"./link":57}],60:[function(require,module,exports){
(function (global){
"use strict";var _global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos,link=require("./link");module.exports=kos.reactor("push").desc("reactions to push dataflow object to remote stream(s)").load(link).in("push/connect").out("link/connect/url").bind(function(n){this.send("link/connect/url",n)}).in("push/listen").out("link/listen/url").bind(function(n){this.send("link/listen/url",n)}).in("link/stream").bind(function(n){this.parent.pipe(n)});
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined,"./link":57}],61:[function(require,module,exports){
(function (global){
"use strict";function indent(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:1,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:" ";return e.replace(/^(?!\s*$)/gm,r.repeat(t))}function findLongest(e){var t=0,r=0,i=0,n=e.length;if(n)for(;n--;)(r=e[n].length)>t&&(i=n,t=r);return e[i]||""}function renderListItem(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{},i=r.width,n=r.height,h=r.isMiddle,d=void 0!==h&&h,a=r.left,o=void 0===a?BOX.L:a,s=r.right,l=void 0===s?BOX.R:s,g="",u=e+SEP.repeat(i-e.length);return g+=1===n?(o.one||"")+u+(l.one||""):0===t?d?(o.mid1||"")+u+(l.mid1||""):(o.top||"")+u+(l.top||""):t<n-1?d?(o.mid2||"")+u+(l.mid2||""):(o.item||"")+u+(l.item||""):d?(o.mid3||"")+u+(l.mid3||""):(o.last||"")+u+(l.last||"")}function renderTrigger(e,t,r,i){var n=e.inputs,h=e.requires,d=e.outputs,a=e.handler,o=void 0===a?{}:a,s=h.concat(n),l={height:s.length,width:r||findLongest(s).length,start:0},g=o.name||"";t||(t=g.length);var u={height:d.length,width:i||findLongest(d).length,start:0},m=l.height>u.height?l.height:u.height,f={height:m,width:0,middle:Math.floor((m-1)/2),lines:[]};l.height>u.height&&(u.start=Math.floor((l.height-u.height)/2)),u.height>l.height&&(l.start=Math.floor((u.height-l.height)/2));for(var c=0,v=0,p=0;c<f.height;c++){var L="";if(c>=l.start&&v<l.height?L+=renderListItem(s[v],v++,{height:l.height,width:l.width,isMiddle:c===f.middle}):L+=SEP.repeat(l.width+6),c===f.middle){var O=FUNC+"("+g+")"+SEP.repeat(t-g.length);u.height?L+=BOX.L.dash+O+BOX.R.dash:L+=BOX.L.dash+O}else L+=SEP.repeat(t+7);c>=u.start&&p<u.height&&(L+=renderListItem(d[p],p++,{height:u.height,width:u.width,right:{},isMiddle:c===f.middle})),f.lines.push(L),L.length>f.width&&(f.width=L.length)}return f}function renderTriggers(e){var t=e.triggers,r=e.inputs,i=e.outputs,n=findLongest(Array.from(r)).length,h=findLongest(Array.from(i)).length,d=findLongest(t.map(function(e){return e.name})).length,a=t.reduce(function(e,r,i){for(var a=renderTrigger(r,d,n,h),o=i==t.length-1,s=0;s<a.lines.length;s++){var l=a.lines[s];l=s<a.middle?BOX.nest+l:s===a.middle?o?BOX.last+l:BOX.item+l:o?SEP+l:BOX.nest+l,e.push(l)}return e},[]);return a.length||a.push(BOX.last+BOX.L.dash+"no triggers"),a.join("\n")}function renderReactorAsTree(e){var t=this.get("module/treeify"),r=e.name,i=e.purpose,n=e.requires,h=e.reactors,d=e.triggers,a="",o={requires:n.sort(),reactors:h.map(function(e){return e.name}),triggers:d.map(function(e){return FUNC+"("+e.name+")"}),"":null};for(var s in o)Array.isArray(o[s])&&(o[s].length?o[s]=o[s].reduce(function(e,t){return e[t]=null,e},{}):delete o[s]);a+=t.asTree(o,!0);var l=!0,g=!1,u=void 0;try{for(var m,f=h[Symbol.iterator]();!(l=(m=f.next()).done);l=!0){var c=m.value;a+="   ├─ "+c.name+": "+c.purpose+"\n",a+=indent(renderReactorAsTree.call(this,c),1,"   │  ")+"\n",a+="   │\n"}}catch(e){g=!0,u=e}finally{try{!l&&f.return&&f.return()}finally{if(g)throw u}}return a+=indent(renderTriggers(e),3),e.parent||(a=r+": "+i+"\n"+a,this.send("reactor/tree",a)),a}var _global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos,BOX={L:{top:"┌╼ ",item:"├╼ ",last:"└╼ ",mid1:"┬╼ ",mid2:"┼╼ ",mid3:"┴╼ ",one:"─╼ ",dash:"╼ "},R:{top:" ╾┐",item:" ╾┤",last:" ╾┘",mid1:" ╾┬",mid2:" ╾┼",mid3:" ╾┴",one:" ╾─",dash:" ╾"},nest:"│",item:"├",last:"└"},FUNC="ƒ",SEP=" ";module.exports=kos.reactor("render").desc("reactions to visually render KOS reactors").in("reactor").and.has("module/treeify").out("reactor/tree").bind(renderReactorAsTree);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined}],62:[function(require,module,exports){
(function (global){
"use strict";function _toConsumableArray(n){if(Array.isArray(n)){for(var t=0,e=Array(n.length);t<n.length;t++)e[t]=n[t];return e}return Array.from(n)}function syncConnect(n){this.send("link/connect/url",n)}function syncListen(n){this.send("link/listen/url",n)}function syncStream(n){var t=this,e=this.get("reactors");n.feed.apply(n,["reactor"].concat(_toConsumableArray(Array.from(e.values())))),this.parent.pipe(n),n.on("active",function(){n.pipe(t.parent),t.debug("synchronizing")})}function collectReactors(n){this.get("reactors").set(n.id,n)}var _global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos,link=require("./link");module.exports=kos.reactor("sync").desc("reactions to synchronize dataflow objects with remote stream(s)").load(link).init("reactors",new Map).in("sync/connect").out("link/connect/url").bind(syncConnect).in("sync/listen").out("link/listen/url").bind(syncListen).in("link/stream").bind(syncStream).in("reactor").bind(collectReactors);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined,"./link":57}],63:[function(require,module,exports){
(function (global){
"use strict";function connect(e){var s=this,t=this.get("module/simple-websocket"),n=this.get("protocols"),o=normalizeOptions(e),r=o.protocol,i=o.hostname,c=o.port,l=o.path,a=o.retry,u=o.max;if(!n.includes(r))return this.error("unsupported protocol",r);var d=r+"//"+i+":"+c+"/"+l,p=new t(d);this.send("link",{addr:d,socket:p}),p.on("connect",function(){s.info("connected to",d),s.send("ws/socket",p),p.emit("active"),a&&(a=100)}),p.on("close",function(){a&&setTimeout(function(){s.debug("attempt reconnect",d),s.send("ws/connect",Object.assign({},e,{retry:Math.round(Math.min(u,1.5*a))}),null)},a)}),p.on("error",this.error.bind(this))}function listen(e){var s=this,t=this.get("module/simple-websocket/server"),n=this.get("protocols"),o=normalizeOptions(e),r=o.protocol,i=o.hostname,c=o.port,l=o.path,a=o.server;if(!n.includes(r))return this.error("unsupported protocol",r);a?(a=new t({server:a}),this.info("listening on existing server instance"),this.send("ws/server",a)):(a=new t({host:i,port:c,path:l}),a.on("listening",function(){s.info("listening",i,c,l),s.send("ws/server",a)})),a.on("connection",function(e){var t=e._ws._socket,n=r+"//"+t.remoteAddress+":"+t.remotePort;s.info("accept",n),s.send("ws/socket",e),s.send("link",{addr:n,socket:e}),e.emit("active")}),a.on("error",this.error.bind(this))}function connectByUrl(e){var s=this.get("module/url"),t=s.parse(e,!0);t.slashes||(t=s.parse("ws://"+e,!0)),this.send("ws/connect",Object.assign(t,t.query))}function listenByUrl(e){var s=this.get("module/url"),t=s.parse(e,!0);t.slashes||(t=s.parse("ws://"+e,!0)),this.send("ws/listen",Object.assign(t,t.query))}function normalizeOptions(e){return{protocol:e.protocol||"ws:",hostname:e.hostname||"0.0.0.0",port:parseInt(e.port,10)||80,path:e.path||"",server:e.server,retry:parseInt(e.retry,10)||100,max:parseInt(e.max,10)||5e3}}var _global=global,_global$kos=_global.kos,kos=void 0===_global$kos?require(".."):_global$kos;module.exports=kos.reactor("ws").desc("reactions to establish WebSocket client/server communication links").init("protocols",["ws:","wss:"]).in("ws/connect").and.has("module/simple-websocket").out("ws/socket","link","ws/connect").bind(connect).in("ws/listen").and.has("module/simple-websocket/server").out("ws/server","ws/socket","link").bind(listen).in("ws/connect/url").and.has("module/url").out("ws/connect").bind(connectByUrl).in("ws/listen/url").and.has("module/url").out("ws/listen").bind(listenByUrl);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"..":undefined}],64:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var kos=require("./node"),core=require("./reactors/core"),debug=require("./reactors/debug"),link=require("./reactors/link"),http=require("./reactors/http"),ws=require("./reactors/ws"),sync=require("./reactors/sync"),pull=require("./reactors/pull"),push=require("./reactors/push");exports.default=kos,exports.core=core,exports.debug=debug,exports.link=link,exports.http=http,exports.ws=ws,exports.sync=sync,exports.pull=pull,exports.push=push;
