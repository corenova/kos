...
"use strict";function _toConsumableArray(e){if(Array.isArray(e)){for(var o=0,r=Array(e.length);o<e.length;o++)r[o]=e[o];return r}return Array.from(e)}function loadFlow(e){var o={},r=[path.resolve(e),path.resolve(path.join("flows",e)),path.resolve(__dirname,path.join("flows",e)),e],t=!0,i=!1,a=void 0;try{for(var n,s=r[Symbol.iterator]();!(t=(n=s.next()).done);t=!0){var l=n.value;try{o=require(l);break}catch(e){if("MODULE_NOT_FOUND"!==e.code)throw e}}}catch(e){i=!0,a=e}finally{try{!t&&s.return&&s.return()}finally{if(i)throw a}}if("KineticObjectStream"!==o.type)throw new Error("unable to load KOS for "+e+" from "+r);this.stream.include(o),this.send("flow",o)}function setupLogger(e){var o=e.verbose,r=void 0===o?0:o,t=e.silent;if(void 0===t||!t){var i=["kos:error","kos:warn"];r&&i.push("kos:info"),r>1&&i.push("kos:debug"),r>2&&i.push("kos:trace"),debug.enable(i.join(","));var a=debug("kos:error"),n=debug("kos:warn"),s=debug("kos:info"),l=debug("kos:debug"),u=debug("kos:trace");this.get("initialized")||(this.stream.on("data",function(e){var o=e.key,t=e.value;switch(o){case"error":a(r>1?t:t.message);break;case"warn":n.apply(void 0,_toConsumableArray(t));break;case"info":s.apply(void 0,_toConsumableArray(t));break;case"debug":l.apply(void 0,_toConsumableArray(t));break;default:"object"===(void 0===t?"undefined":_typeof(t))?u("%s\n%O\n",o,t):u("%s %o",o,t)}}),this.set("initialized",!0))}}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},KineticObjectStream=require("./lib/stream"),KineticReactor=require("./lib/reactor"),KineticEssence=require("./lib/essence"),debug=require("debug"),path=require("path"),kos=new KineticObjectStream("core").summary("Provides KOS flow loading & logging facility").in("load").out("flow").bind(loadFlow).in("log").bind(setupLogger);kos.Stream=KineticObjectStream,kos.Reactor=KineticReactor,kos.Essence=KineticEssence,global.kos=module.exports=kos.default=kos.kos=kos;
...
},{"./_stream_duplex":26,"./internal/streams/BufferList":31,"_process":24,"buffer":10,"buffer-shims":9,"core-util-is":12,"events":16,"inherits":18,"isarray":20,"process-nextick-args":23,"stream":36,"string_decoder/":37,"util":8}],29:[function(require,module,exports){
...
},{"./_stream_duplex":26,"_process":24,"buffer":10,"buffer-shims":9,"core-util-is":12,"events":16,"inherits":18,"process-nextick-args":23,"stream":36,"util-deprecate":38}],31:[function(require,module,exports){
...
},{"./lib/_stream_duplex.js":26,"./lib/_stream_passthrough.js":27,"./lib/_stream_readable.js":28,"./lib/_stream_transform.js":29,"./lib/_stream_writable.js":30,"_process":24,"stream":36}],34:[function(require,module,exports){
