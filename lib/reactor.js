...
class KineticReactor extends KineticStream {
  ...
  link(stream)   { this.core.pipe(stream).pipe(this.core); return this; }
  unlink(stream) { this.core.unpipe(stream).unpipe(this.core); return this; }

  enable()  { this._enabled = true; this.pipe(this.core).pipe(this); return this; }
  disable() { this._enabled = false; this.unpipe(this.core).unpipe(this); return this; }
