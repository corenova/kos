...
class Reactor extends Dataflow {
  ...
  get persona()   { return this.parent && this.parent.type === Symbol.for('kos:persona') ? this.parent : null }
  ...
  get cache() {
    if (!this._cache) {
      ...
      //debug(this.identity, this.passive, this.absorbs)
