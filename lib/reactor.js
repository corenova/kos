...
class KineticReactor extends KineticStream {
  ...
  constructor(props) {
    ...
    let KineticInstance = state => this.create(this).save(state, { feed: true })
    return Object.setPrototypeOf(KineticInstance, this)
  }

  create() { return new KineticReactor(...arguments) }

  desc(purpose='')    { this._props.purpose = purpose; return this }
  pass(passive=false) { this._props.passive = passive; return this }
  ...
  get notify()  { return this.listenerCount('trace') > 0 }
